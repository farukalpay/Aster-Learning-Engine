...
constexpr aster::Vec3 kCaveIndustrialRedLight{1.0f, 0.30f, 0.12f};
constexpr float kAuthoredCaveFixtureIntensity = 11.5f;
constexpr float kAuthoredCaveFixtureSourceRadius = 1.10f;
