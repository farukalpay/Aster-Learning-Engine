...
static void buildTriangleAdjacency(TriangleAdjacency& adjacency, const unsigned int* indices, size_t index_count, size_t vertex_count, meshwork_Allocator& allocator)
{
...
void meshwork_optimizeVertexCacheTable(unsigned int* destination, const unsigned int* indices, size_t index_count, size_t vertex_count, const meshwork::VertexScoreTable* table)
{
...
void meshwork_optimizeVertexCache(unsigned int* destination, const unsigned int* indices, size_t index_count, size_t vertex_count)
{
	meshwork_optimizeVertexCacheTable(destination, indices, index_count, vertex_count, &meshwork::kVertexScoreTable);
}

void meshwork_optimizeVertexCacheStrip(unsigned int* destination, const unsigned int* indices, size_t index_count, size_t vertex_count)
{
	meshwork_optimizeVertexCacheTable(destination, indices, index_count, vertex_count, &meshwork::kVertexScoreTableStrip);
}

void meshwork_optimizeVertexCacheFifo(unsigned int* destination, const unsigned int* indices, size_t index_count, size_t vertex_count, unsigned int cache_size)
{
	using namespace meshwork;
