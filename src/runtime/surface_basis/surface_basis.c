...
static int GenerateInitialVerticesIndexList(STriInfo pTriInfos[], int piTriList_out[], const SSurfaceBasisContext * pContext, const int iNrTrianglesIn);
static void GenerateSharedVerticesIndexList(int piTriList_in_and_out[], const SSurfaceBasisContext * pContext, const int iNrTrianglesIn);
static void InitTriInfo(STriInfo pTriInfos[], const int piTriListIn[], const SSurfaceBasisContext * pContext, const int iNrTrianglesIn);
...
static tbool GenerateTSpaces(STSpace psTspace[], const STriInfo pTriInfos[], const SGroup pGroups[],
                             ...
                             const SSurfaceBasisContext * pContext);
...
static SVec3 GetPosition(const SSurfaceBasisContext * pContext, const int index);
static SVec3 GetNormal(const SSurfaceBasisContext * pContext, const int index);
static SVec3 GetTexCoord(const SSurfaceBasisContext * pContext, const int index);


// degen triangles
static void DegenPrologue(STriInfo pTriInfos[], int piTriList_out[], const int iNrTrianglesIn, const int iTotTris);
static void DegenEpilogue(STSpace psTspace[], STriInfo pTriInfos[], int piTriListIn[], const SSurfaceBasisContext * pContext, const int iNrTrianglesIn, const int iTotTris);


tbool genTangSpaceDefault(const SSurfaceBasisContext * pContext)
{
...
static void MergeVertsFast(int piTriList_in_and_out[], STmpVert pTmpVert[], const SSurfaceBasisContext * pContext, const int iL_in, const int iR_in);
static void MergeVertsSlow(int piTriList_in_and_out[], const SSurfaceBasisContext * pContext, const int pTable[], const int iEntries);
static void GenerateSharedVerticesIndexListSlow(int piTriList_in_and_out[], const SSurfaceBasisContext * pContext, const int iNrTrianglesIn);
...
static float CalcTexArea(const SSurfaceBasisContext * pContext, const int indices[])
{
...
static STSpace EvalTspace(int face_indices[], const int iFaces, const int piTriListIn[], const STriInfo pTriInfos[], const SSurfaceBasisContext * pContext, const int iVertexRepresentitive);
...
static STSpace EvalTspace(int face_indices[], const int iFaces, const int piTriListIn[], const STriInfo pTriInfos[],
                          const SSurfaceBasisContext * pContext, const int iVertexRepresentitive)
{
	STSpace res;
	float fAngleSum = 0;
	int face=0;
