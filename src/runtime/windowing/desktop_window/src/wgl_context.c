...
//
static int choosePixelFormatWGL(_DESKTOP_WINDOWwindow* window,
                                ...
                                const _DESKTOP_WINDOWfbconfig* fbconfig)
{
    ...
    if (_desktop_window.wgl.ARB_pixel_format)
    {
        ...
        {
            if (_desktop_window.wgl.EXT_colorspace)
        ...
        nativeCount = _desktop_window_min(nativeCount, extensionCount);
    }
...
static void makeContextCurrentWGL(_DESKTOP_WINDOWwindow* window)
{
    if (window)
    {
        ...
        else
        {
            ...
            _desktop_windowPlatformSetTls(&_desktop_window.contextSlot, NULL);
        }
    }
    else
    {
...
static void swapBuffersWGL(_DESKTOP_WINDOWwindow* window)
{
    if (!window->monitor)
    {
...
static void swapIntervalWGL(int interval)
{
    ...
    if (_desktop_window.wgl.EXT_swap_control)
...
static int extensionSupportedWGL(const char* extension)
{
    ...
    if (_desktop_window.wgl.GetExtensionsStringARB)
        extensions = wglGetExtensionsStringARB(wglGetCurrentDC());
    else if (_desktop_window.wgl.GetExtensionsStringEXT)
        extensions = wglGetExtensionsStringEXT();

    if (!extensions)
        return DESKTOP_WINDOW_FALSE;

    return _desktop_windowStringInExtensionString(extension, extensions);
}

static DESKTOP_WINDOWglproc getProcAddressWGL(const char* procname)
{
    const DESKTOP_WINDOWglproc proc = (DESKTOP_WINDOWglproc) wglGetProcAddress(procname);
    if (proc)
        return proc;

    return (DESKTOP_WINDOWglproc) _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, procname);
}

static void destroyContextWGL(_DESKTOP_WINDOWwindow* window)
{
...
DESKTOP_WINDOWbool _desktop_windowInitWGL(void)
{
    ...
    _desktop_window.wgl.CreateContext = (PFN_wglCreateContext)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglCreateContext");
    _desktop_window.wgl.DeleteContext = (PFN_wglDeleteContext)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglDeleteContext");
    _desktop_window.wgl.GetProcAddress = (PFN_wglGetProcAddress)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglGetProcAddress");
    _desktop_window.wgl.GetCurrentDC = (PFN_wglGetCurrentDC)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglGetCurrentDC");
    _desktop_window.wgl.GetCurrentContext = (PFN_wglGetCurrentContext)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglGetCurrentContext");
    _desktop_window.wgl.MakeCurrent = (PFN_wglMakeCurrent)
        _desktop_windowPlatformGetModuleSymbol(_desktop_window.wgl.instance, "wglMakeCurrent");
    ...
    dc = GetDC(_desktop_window.win32.helperWindowHandle);
    ...
    _desktop_window.wgl.GetExtensionsStringEXT = (PFNWGLGETEXTENSIONSSTRINGEXTPROC)
        wglGetProcAddress("wglGetExtensionsStringEXT");
    _desktop_window.wgl.GetExtensionsStringARB = (PFNWGLGETEXTENSIONSSTRINGARBPROC)
        wglGetProcAddress("wglGetExtensionsStringARB");
    _desktop_window.wgl.CreateContextAttribsARB = (PFNWGLCREATECONTEXTATTRIBSARBPROC)
        wglGetProcAddress("wglCreateContextAttribsARB");
    _desktop_window.wgl.SwapIntervalEXT = (PFNWGLSWAPINTERVALEXTPROC)
        wglGetProcAddress("wglSwapIntervalEXT");
    _desktop_window.wgl.GetPixelFormatAttribivARB = (PFNWGLGETPIXELFORMATATTRIBIVARBPROC)
        wglGetProcAddress("wglGetPixelFormatAttribivARB");

    // NOTE: WGL_ARB_extensions_string and WGL_EXT_extensions_string are not
    //       checked below as we are already using them
    _desktop_window.wgl.ARB_multisample =
        extensionSupportedWGL("WGL_ARB_multisample");
    _desktop_window.wgl.ARB_framebuffer_sRGB =
        extensionSupportedWGL("WGL_ARB_framebuffer_sRGB");
    _desktop_window.wgl.EXT_framebuffer_sRGB =
        extensionSupportedWGL("WGL_EXT_framebuffer_sRGB");
    _desktop_window.wgl.ARB_create_context =
        extensionSupportedWGL("WGL_ARB_create_context");
    _desktop_window.wgl.ARB_create_context_profile =
        extensionSupportedWGL("WGL_ARB_create_context_profile");
    _desktop_window.wgl.EXT_create_context_es2_profile =
        extensionSupportedWGL("WGL_EXT_create_context_es2_profile");
    _desktop_window.wgl.ARB_create_context_robustness =
        extensionSupportedWGL("WGL_ARB_create_context_robustness");
    _desktop_window.wgl.ARB_create_context_no_error =
        extensionSupportedWGL("WGL_ARB_create_context_no_error");
    _desktop_window.wgl.EXT_swap_control =
        extensionSupportedWGL("WGL_EXT_swap_control");
    _desktop_window.wgl.EXT_colorspace =
        extensionSupportedWGL("WGL_EXT_colorspace");
    _desktop_window.wgl.ARB_pixel_format =
        extensionSupportedWGL("WGL_ARB_pixel_format");
    _desktop_window.wgl.ARB_context_flush_control =
...
{
    if (_desktop_window.wgl.instance)
        _desktop_windowPlatformFreeModule(_desktop_window.wgl.instance);
}
                               ...
                               const _DESKTOP_WINDOWfbconfig* fbconfig)
{
    ...
    if (_desktop_window.wgl.ARB_create_context)
    {
        ...
        {
            if (_desktop_window.wgl.ARB_create_context_robustness)
            {
        ...
        {
            if (_desktop_window.wgl.ARB_context_flush_control)
            {
...
DESKTOP_WINDOWAPI HGLRC desktop_windowGetWGLContext(DESKTOP_WINDOWwindow* handle)
{
