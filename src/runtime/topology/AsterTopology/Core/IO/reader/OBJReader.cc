              ...
              Options & fileOptions)
{
    ...
    while( _in && !_in.eof() )
    {
        ...
        if (keyWrd == "v")
        {
          ...
          if ( !stream.fail() )
          {
            vertexHandles.push_back(_bi.add_vertex(AsterTopology::Vec3f(x,y,z)));
            ...
            if ( !stream.fail() )
            {
              if (  userOptions.vertex_has_color() ) {
                ...
                colors.push_back(AsterTopology::Vec3f(r,g,b));
              }
            }
          }
        }
        ...
        else if (keyWrd == "vt")
        {
          ...
          if ( !stream.fail()  ){
            ...
            if ( userOptions.vertex_has_texcoord() || userOptions.face_has_texcoord() ) {
              texcoords.push_back(AsterTopology::Vec2f(u, v));
              ...
              stream >> w;
              if ( !stream.fail()  )
                  texcoords3d.push_back(AsterTopology::Vec3f(u, v, w));
        ...
        else if (keyWrd == "vn")
        {
          ...
          if ( !stream.fail() ) {
            if (userOptions.vertex_has_normal() ){
              normals.push_back(AsterTopology::Vec3f(x,y,z));
