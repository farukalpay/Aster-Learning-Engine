...
//=============================================================================
//
//  Implements an exporter module for arbitrary AsterTopology meshes
//
//=============================================================================
...
/**
 *  This class template provides an exporter module for AsterTopology meshes.
 */
template <class Mesh>
...
public:
  ...
  AsterTopology::Attributes::StatusInfo  status(VertexHandle _vh) const
  {
    if (mesh_.has_vertex_status())
      return mesh_.status(_vh);
    return AsterTopology::Attributes::StatusInfo();
  }
  ...
  AsterTopology::Attributes::StatusInfo  status(EdgeHandle _eh) const
  {
  ...
  AsterTopology::Attributes::StatusInfo  status(HalfedgeHandle _heh) const
  {
  ...
  AsterTopology::Attributes::StatusInfo  status(FaceHandle _fh) const
  {
