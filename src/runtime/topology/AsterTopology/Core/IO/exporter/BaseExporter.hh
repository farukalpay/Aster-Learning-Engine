...
class ASTER_TOPOLOGYDLLEXPORT BaseExporter
{
public:
  ...
  virtual AsterTopology::Attributes::StatusInfo  status(VertexHandle _vh) const = 0;
  ...
  virtual AsterTopology::Attributes::StatusInfo  status(FaceHandle _fh) const = 0;
  ...
  virtual AsterTopology::Attributes::StatusInfo  status(EdgeHandle _eh) const = 0;
  ...
  virtual AsterTopology::Attributes::StatusInfo  status(HalfedgeHandle _heh) const = 0;
