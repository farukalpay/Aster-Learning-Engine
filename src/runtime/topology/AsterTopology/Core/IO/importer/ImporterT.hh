...
//=============================================================================
//
//  Implements an importer module for arbitrary AsterTopology meshes
//
//=============================================================================
...
#include <AsterTopology/Core/Utils/vector_cast.hh>
...
/**
 *  This class template provides an importer module for AsterTopology meshes.
 */
template <class Mesh>
...
public:
  ...
  virtual void set_status(VertexHandle _vh, const AsterTopology::Attributes::StatusInfo& _status)
  {
    if (!mesh_.has_vertex_status())
  ...
  virtual void set_status(HalfedgeHandle _heh, const AsterTopology::Attributes::StatusInfo& _status)
  {
  ...
  virtual void set_status(EdgeHandle _eh, const AsterTopology::Attributes::StatusInfo& _status)
  {
    if (!mesh_.has_edge_status())
  ...
  virtual void set_status(FaceHandle _fh, const AsterTopology::Attributes::StatusInfo& _status)
  {
    if (!mesh_.has_face_status())
  ...
  virtual void add_texture_information( int _id , std::string _name ) {
    AsterTopology::MPropHandleT< std::map< int, std::string > > property;
