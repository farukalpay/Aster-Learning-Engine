...
// -------------------- check include order
#if defined (ASTER_TOPOLOGY_TRIMESH_ARRAY_KERNEL_HH) || \
    defined (ASTER_TOPOLOGY_POLYMESH_ARRAY_KERNEL_HH)

    // Issue warning if MeshIO was not included before Mesh Type
    // Nobody knows why this order was enforced.
    // If somebody encounters an error resulting from a wrong order, please report it to the AsterTopology developers.
...
// -------------------- AsterTopology
#include <AsterTopology/Core/IO/SR_store.hh>
#include <AsterTopology/Core/IO/IOManager.hh>
#include <AsterTopology/Core/IO/importer/ImporterT.hh>
#include <AsterTopology/Core/IO/exporter/ExporterT.hh>
...
/** \name Mesh Reading / Writing
    ...
    \see AsterTopology::IO::_IOManager_
*/
//@{
...
/** \brief Read a mesh from file _filename.
    ...
    \note If you link statically against AsterTopology, you have to add
...
#  include <AsterTopology/Core/IO/IOInstances.hh>
#endif
//=============================================================================
#endif
//=============================================================================
