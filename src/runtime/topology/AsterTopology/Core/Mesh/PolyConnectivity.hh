#ifndef ASTER_TOPOLOGY_POLYCONNECTIVITY_HH
#define ASTER_TOPOLOGY_POLYCONNECTIVITY_HH

#include <AsterTopology/Core/Mesh/ArrayKernel.hh>
...
*/
class ASTER_TOPOLOGYDLLEXPORT PolyConnectivity : public ArrayKernel
{
public:
  /// \name Mesh Handles
  //@{
  ...
  /** \name Mesh Iterators
      Refer to AsterTopology::Mesh::Iterators or \ref mesh_iterators for
      documentation.
  */
  //@{
  /// Linear iterator
...
public:
  ...
  */
   ...
   * at the boundary of the mesh, as AsterTopology will make sure, that if there is a
...
#endif//ASTER_TOPOLOGY_POLYCONNECTIVITY_HH
