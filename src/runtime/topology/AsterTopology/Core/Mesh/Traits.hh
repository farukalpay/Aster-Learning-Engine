...
#ifndef ASTER_TOPOLOGY_TRAITS_HH
#define ASTER_TOPOLOGY_TRAITS_HH
...
/** \class DefaultTraits Traits.hh <AsterTopology/Mesh/Traits.hh>
...
{
  /// The default coordinate type is AsterTopology::Vec3f.
  typedef Vec3f  Point;

  /// The default normal type is AsterTopology::Vec3f.
  typedef Vec3f  Normal;

  /// The default 1D texture coordinate type is float.
  typedef float  TexCoord1D;
  /// The default 2D texture coordinate type is AsterTopology::Vec2f.
  typedef Vec2f  TexCoord2D;
  /// The default 3D texture coordinate type is AsterTopology::Vec3f.
  typedef Vec3f  TexCoord3D;

  /// The default texture index type
  typedef int TextureIndex;

  /// The default color type is AsterTopology::Vec3uc.
...
#define OM_Merge_Traits(_S1, _S2, _D) \
  typedef AsterTopology::MergeTraits<_S1, _S2>::Result _D;
...
#define OM_Merge_Traits_In_Template(_S1, _S2, _D) \
  typedef typename AsterTopology::MergeTraits<_S1, _S2>::Result _D;


//=============================================================================
} // namespace AsterTopology
//=============================================================================
#endif // ASTER_TOPOLOGY_TRAITS_HH defined
//=============================================================================
