#ifndef ASTER_TOPOLOGY_TRICONNECTIVITY_HH
#define ASTER_TOPOLOGY_TRICONNECTIVITY_HH
...
*/
class ASTER_TOPOLOGYDLLEXPORT TriConnectivity : public PolyConnectivity
{
public:
  ...
  */
   ...
   *
   * Override AsterTopology::Mesh::PolyMeshT::add_face(). Faces that aren't
...
#endif//ASTER_TOPOLOGY_TRICONNECTIVITY_HH
