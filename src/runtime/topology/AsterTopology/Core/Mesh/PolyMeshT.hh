...
#ifndef ASTER_TOPOLOGY_POLYMESHT_HH
#define ASTER_TOPOLOGY_POLYMESHT_HH
...
#include <AsterTopology/Core/Geometry/MathDefs.hh>
...
/** \class PolyMeshT PolyMeshT.hh <AsterTopology/Mesh/PolyMeshT.hh>
...
public:
  ...
  /** \name Mesh Circulators
      Refer to AsterTopology::Mesh::Iterators or \ref mesh_iterators
      for documentation.
  */
  //@{
  /// Circulator
  ...
  */
  ...
  unsigned int find_feature_edges(Scalar _angle_tresh = AsterTopology::deg_to_rad(44.0));
  // --- misc ---
...
//=============================================================================
#if defined(OM_INCLUDE_TEMPLATES) && !defined(ASTER_TOPOLOGY_POLYMESH_C)
#  define ASTER_TOPOLOGY_POLYMESH_TEMPLATES
#  include "PolyMeshT.cc"
#endif
//=============================================================================
#endif // ASTER_TOPOLOGY_POLYMESHT_HH defined
//=============================================================================
