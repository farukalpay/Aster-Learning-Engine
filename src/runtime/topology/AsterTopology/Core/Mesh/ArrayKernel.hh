...
#ifndef ASTER_TOPOLOGY_ARRAY_KERNEL_HH
#define ASTER_TOPOLOGY_ARRAY_KERNEL_HH
...
#include <AsterTopology/Core/Mesh/ArrayItems.hh>
...
/** \ingroup mesh_kernels_group
    ...
    AsterTopology::Mesh::BaseKernel.
    \note You do not have to use this class directly, use the predefined
    mesh-kernel combinations in \ref mesh_types_group.
    \see AsterTopology::Concepts::KernelT, \ref mesh_type
*/

class ASTER_TOPOLOGYDLLEXPORT ArrayKernel : public BaseKernel, public ArrayItems
{
public:
...
public:
   ...
   *
   * Usually if you delete primitives in AsterTopology, they are only flagged as deleted.
...
//=============================================================================
#if defined(OM_INCLUDE_TEMPLATES) && !defined(ASTER_TOPOLOGY_ARRAY_KERNEL_C)
#  define ASTER_TOPOLOGY_ARRAY_KERNEL_TEMPLATES
#  include "ArrayKernelT.cc"
#endif
//=============================================================================
#endif // ASTER_TOPOLOGY_ARRAY_KERNEL_HH defined
//=============================================================================
