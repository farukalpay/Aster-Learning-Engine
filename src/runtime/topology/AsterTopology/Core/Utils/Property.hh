#ifndef ASTER_TOPOLOGY_PROPERTY_HH
#define ASTER_TOPOLOGY_PROPERTY_HH
...
/** \class PropertyT Property.hh <AsterTopology/Core/Utils/PropertyT.hh>
 *
...
public: // data access interface
  ...
  /// Get reference to property vector (be careful, improper usage, e.g. resizing, may crash AsterTopology!!!)
...
//=============================================================================
#endif // ASTER_TOPOLOGY_PROPERTY_HH defined
//=============================================================================
