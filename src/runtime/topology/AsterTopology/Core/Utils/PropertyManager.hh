...
#include <AsterTopology/Core/Utils/HandleToPropHandle.hh>
#include <sstream>
#include <stdexcept>
#include <string>
...
class PropertyManager {
    ...
    public:
        ...
        static void copy(const char *prop_name,
            ...
            typedef AsterTopology::PropertyManager<PROPTYPE, MeshT> DstPM;
            DstPM dst(DstPM::createIfNotExists(dst_mesh, prop_name));

            typedef AsterTopology::PropertyManager<PROPTYPE, MeshT_2> SrcPM;
