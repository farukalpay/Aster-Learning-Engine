#ifndef ASTER_TOPOLOGY_BASEPROPERTY_HH
#define ASTER_TOPOLOGY_BASEPROPERTY_HH

#include <string>
#include <AsterTopology/Core/IO/StoreRestore.hh>
...
/** \class BaseProperty Property.hh <AsterTopology/Core/Utils/PropertyT.hh>

    Abstract class defining the basic interface of a dynamic property.
**/

class ASTER_TOPOLOGYDLLEXPORT BaseProperty
{
public:
...
public:
  ...
  ///
  /// In %AsterTopology all mesh data is stored in so-called properties.
...
#endif //ASTER_TOPOLOGY_BASEPROPERTY_HH
