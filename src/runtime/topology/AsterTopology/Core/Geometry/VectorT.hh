...
#if ((defined(_MSC_VER) && (_MSC_VER >= 1900)) || __cplusplus > 199711L || defined(__GXX_EXPERIMENTAL_CXX0X__)) && !defined(ASTER_TOPOLOGY_VECTOR_LEGACY)
#include "Vector11T.hh"
#else
#ifndef DOXYGEN

#ifndef ASTER_TOPOLOGY_VECTOR_HH
#define ASTER_TOPOLOGY_VECTOR_HH
...
/** \class VectorT VectorT.hh <AsterTopology/Core/Math/VectorT.hh>
...
#endif // ASTER_TOPOLOGY_VECTOR_HH defined
//=============================================================================
#endif // DOXYGEN
#endif // C++11
