#ifndef ASTER_TOPOLOGY_SRC_ASTER_TOPOLOGY_CORE_GEOMETRY_VECTOR11T_HH_
#define ASTER_TOPOLOGY_SRC_ASTER_TOPOLOGY_CORE_GEOMETRY_VECTOR11T_HH_
 ...
 * Example:
 * \code{.cpp}
 * AsterTopology::Vec4f light_blue = 0x1FCFFFFF_htmlColor;
 * \endcode
 */
constexpr AsterTopology::Vec4f operator"" _htmlColor(unsigned long long raw_color) {
    return AsterTopology::Vec4f(
...
#endif /* ASTER_TOPOLOGY_SRC_ASTER_TOPOLOGY_CORE_GEOMETRY_VECTOR11T_HH_ */
