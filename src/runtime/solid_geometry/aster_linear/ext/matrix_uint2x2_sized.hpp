...
/// @file aster_linear/ext/matrix_uint2x2_sized.hpp
///
/// @see core (dependence)
///
/// @defgroup ext_matrix_uint2x2_sized ASTER_LINEAR_EXT_matrix_uint2x2_sized
/// @ingroup ext
///
/// Include <aster_linear/ext/matrix_uint2x2_sized.hpp> to use the features of this extension.
///
...
#	pragma message("ASTER_LINEAR: ASTER_LINEAR_EXT_matrix_uint2x2_sized extension included")
#endif
