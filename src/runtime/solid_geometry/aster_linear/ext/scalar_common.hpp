...
/// @file aster_linear/ext/scalar_common.hpp
///
/// @defgroup ext_scalar_common ASTER_LINEAR_EXT_scalar_common
/// @ingroup ext
///
/// Exposes min and max functions for 3 to 4 scalar parameters.
///
/// Include <aster_linear/ext/scalar_common.hpp> to use the features of this extension.
///
...
#	pragma message("ASTER_LINEAR: ASTER_LINEAR_EXT_scalar_common extension included")
#endif
...
namespace aster_linear
{
	...
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T min(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T min(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T max(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T max(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmin(T a, T b);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmin(T a, T b, T c);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmin(T a, T b, T c, T d);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmax(T a, T b);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmax(T a, T b, T C);
	...
	/// @see ext_scalar_common
	template<typename T>
	ASTER_LINEAR_FUNC_DECL T fmax(T a, T b, T C, T D);
	...
	/// @see ext_scalar_common extension.
	template<typename genType>
	ASTER_LINEAR_FUNC_DECL genType mirrorRepeat(genType const& Texcoord);
