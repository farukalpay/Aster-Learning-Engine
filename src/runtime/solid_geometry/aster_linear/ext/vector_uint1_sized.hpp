...
/// @file aster_linear/ext/vector_uint1_sized.hpp
///
/// @defgroup ext_vector_uint1_sized ASTER_LINEAR_EXT_vector_uint1_sized
/// @ingroup ext
///
/// Exposes sized unsigned integer vector types.
///
/// Include <aster_linear/ext/vector_uint1_sized.hpp> to use the features of this extension.
///
...
#	pragma message("ASTER_LINEAR: ASTER_LINEAR_EXT_vector_uint1_sized extension included")
#endif
