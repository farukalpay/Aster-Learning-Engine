...
///
/// Include <aster_linear/common.hpp> to use these core features.
...
namespace aster_linear
{
	...
	template<typename genType>
	ASTER_LINEAR_FUNC_DECL genType mod(genType x, genType y);

	template<length_t L, typename T, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> mod(vec<L, T, Q> const& x, T y);
	...
	/// float a;
	/// bool b;
	/// aster_linear::dvec3 e;
	/// aster_linear::dvec3 f;
	/// aster_linear::vec4 g;
	/// aster_linear::vec4 h;
	/// ...
	/// aster_linear::vec4 r = aster_linear::mix(g, h, a); // Interpolate with a floating-point scalar two vectors.
	/// aster_linear::vec4 s = aster_linear::mix(g, h, b); // Returns g or h;
	/// aster_linear::dvec3 t = aster_linear::mix(e, f, a); // Types of the third parameter is not required to match with the first and the second.
	/// aster_linear::vec4 u = aster_linear::mix(g, h, r); // Interpolations can be perform per component with a vector for the last parameter.
	/// @endcode
	template<typename genTypeT, typename genTypeU>
	ASTER_LINEAR_FUNC_DECL genTypeT mix(genTypeT x, genTypeT y, genTypeU a);

	template<length_t L, typename T, typename U, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> mix(vec<L, T, Q> const& x, vec<L, T, Q> const& y, vec<L, U, Q> const& a);

	template<length_t L, typename T, typename U, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> mix(vec<L, T, Q> const& x, vec<L, T, Q> const& y, U a);
	...
	template<length_t L, typename T, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> smoothstep(T edge0, T edge1, vec<L, T, Q> const& x);

	template<length_t L, typename T, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> smoothstep(vec<L, T, Q> const& edge0, vec<L, T, Q> const& edge1, vec<L, T, Q> const& x);
	...
	template<length_t L, typename T, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> frexp(vec<L, T, Q> const& v, vec<L, int, Q>& exp);
	...
	template<length_t L, typename T, qualifier Q>
	ASTER_LINEAR_FUNC_DECL vec<L, T, Q> ldexp(vec<L, T, Q> const& v, vec<L, int, Q> const& exp);
