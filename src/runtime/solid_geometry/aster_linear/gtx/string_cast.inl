...
namespace detail
{
	...
	ASTER_LINEAR_FUNC_QUALIFIER std::string format(const char* msg, ...)
	{
		std::size_t const STRING_BUFFER(4096);
		char text[STRING_BUFFER];
		va_list list;

		if(msg == ASTER_LINEAR_NULLPTR)
			return std::string();
...
#		endif//
	...
	struct literal
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "%d";}
	};

	template<typename T>
	struct literal<T, true>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "%f";}
	};

#	if ASTER_LINEAR_MODEL == ASTER_LINEAR_MODEL_32 && ASTER_LINEAR_COMPILER && ASTER_LINEAR_COMPILER_VC
	template<>
	struct literal<uint64_t, false>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "%lld";}
	};
...
#	endif//ASTER_LINEAR_MODEL == ASTER_LINEAR_MODEL_32 && ASTER_LINEAR_COMPILER && ASTER_LINEAR_COMPILER_VC
	...
	struct prefix<float>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "";}
	};
	...
	struct prefix<bool>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "b";}
	};

	template<>
	struct prefix<uint8_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "u8";}
	};

	template<>
	struct prefix<int8_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "i8";}
	};

	template<>
	struct prefix<uint16_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "u16";}
	};

	template<>
	struct prefix<int16_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "i16";}
	};

	template<>
	struct prefix<uint32_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "u";}
	};

	template<>
	struct prefix<int32_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "i";}
	};

	template<>
	struct prefix<uint64_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "u64";}
	};

	template<>
	struct prefix<int64_t>
	{
		ASTER_LINEAR_FUNC_QUALIFIER static char const * value() {return "i64";}
	};
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<1, bool, Q> const& x)
		{
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<2, bool, Q> const& x)
		{
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<3, bool, Q> const& x)
		{
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<4, bool, Q> const& x)
		{
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<1, T, Q> const& x)
		{
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<2, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<3, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(vec<4, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<2, 2, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<2, 3, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<2, 4, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<3, 2, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<3, 3, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<3, 4, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<4, 2, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<4, 3, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(mat<4, 4, T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(qua<T, Q> const& q)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
	...
	{
		ASTER_LINEAR_FUNC_QUALIFIER static std::string call(tdualquat<T, Q> const& x)
		{
			char const * PrefixStr = prefix<T>::value();
			char const * LiteralStr = literal<T, std::numeric_limits<T>::is_iec559>::value();
...
ASTER_LINEAR_FUNC_QUALIFIER std::string to_string(matType const& x)
{
