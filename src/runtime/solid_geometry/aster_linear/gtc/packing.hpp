/// @ref gtc_packing
/// @file aster_linear/gtc/packing.hpp
///
/// @see core (dependence)
///
/// @defgroup gtc_packing ASTER_LINEAR_GTC_packing
/// @ingroup gtc
///
/// Include <aster_linear/gtc/packing.hpp> to use the features of this extension.
///
...
#	pragma message("ASTER_LINEAR: ASTER_LINEAR_GTC_packing extension included")
#endif
...
namespace aster_linear
{
	...
	ASTER_LINEAR_FUNC_DECL uint32 packI3x10_1x2(ivec4 const& v);
	...
	ASTER_LINEAR_FUNC_DECL uint32 packU3x10_1x2(uvec4 const& v);
	...
	/// @see vec4 unpackSnorm3x10_1x2(uint32 const& p);
	/// @see uvec4 unpackI3x10_1x2(uint32 const& p);
	ASTER_LINEAR_FUNC_DECL uvec4 unpackU3x10_1x2(uint32 p);
	...
	/// @see uint32 packU3x10_1x2(uvec4 const& v)
	/// @see uint32 packI3x10_1x2(ivec4 const& v)
	ASTER_LINEAR_FUNC_DECL uint32 packSnorm3x10_1x2(vec4 const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec4 unpackSnorm3x10_1x2(uint32 p);
	...
	/// @see uint32 packU3x10_1x2(uvec4 const& v)
	/// @see uint32 packI3x10_1x2(ivec4 const& v)
	ASTER_LINEAR_FUNC_DECL uint32 packUnorm3x10_1x2(vec4 const& v);
	...
	/// @see uvec4 unpackI3x10_1x2(uint32 const& p)
	/// @see uvec4 unpackU3x10_1x2(uint32 const& p)
	ASTER_LINEAR_FUNC_DECL vec4 unpackUnorm3x10_1x2(uint32 p);
	...
	ASTER_LINEAR_FUNC_DECL uint32 packF2x11_1x10(vec3 const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec3 unpackF2x11_1x10(uint32 p);
	...
	ASTER_LINEAR_FUNC_DECL uint32 packF3x9_E1x5(vec3 const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec<L, uintType, Q> packUnorm(vec<L, floatType, Q> const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec<L, floatType, Q> unpackUnorm(vec<L, uintType, Q> const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec<L, intType, Q> packSnorm(vec<L, floatType, Q> const& v);
	...
	ASTER_LINEAR_FUNC_DECL vec<L, floatType, Q> unpackSnorm(vec<L, intType, Q> const& v);

	/// Convert each component of the normalized floating-point vector into unsigned integer values.
	///
	/// @see gtc_packing
	/// @see vec2 unpackUnorm2x4(uint8 p)
	ASTER_LINEAR_FUNC_DECL uint8 packUnorm2x4(vec2 const& v);

	/// Convert a packed integer to a normalized floating-point vector.
	///
	/// @see gtc_packing
	/// @see uint8 packUnorm2x4(vec2 const& v)
	ASTER_LINEAR_FUNC_DECL vec2 unpackUnorm2x4(uint8 p);

	/// Convert each component of the normalized floating-point vector into unsigned integer values.
	///
	/// @see gtc_packing
	/// @see vec4 unpackUnorm4x4(uint16 p)
	ASTER_LINEAR_FUNC_DECL uint16 packUnorm4x4(vec4 const& v);

	/// Convert a packed integer to a normalized floating-point vector.
	///
	/// @see gtc_packing
	/// @see uint16 packUnorm4x4(vec4 const& v)
	ASTER_LINEAR_FUNC_DECL vec4 unpackUnorm4x4(uint16 p);

	/// Convert each component of the normalized floating-point vector into unsigned integer values.
	///
	/// @see gtc_packing
	/// @see vec3 unpackUnorm1x5_1x6_1x5(uint16 p)
	ASTER_LINEAR_FUNC_DECL uint16 packUnorm1x5_1x6_1x5(vec3 const& v);

	/// Convert a packed integer to a normalized floating-point vector.
	///
	/// @see gtc_packing
	/// @see uint16 packUnorm1x5_1x6_1x5(vec3 const& v)
	ASTER_LINEAR_FUNC_DECL vec3 unpackUnorm1x5_1x6_1x5(uint16 p);

	/// Convert each component of the normalized floating-point vector into unsigned integer values.
	///
	/// @see gtc_packing
	/// @see vec4 unpackUnorm3x5_1x1(uint16 p)
	ASTER_LINEAR_FUNC_DECL uint16 packUnorm3x5_1x1(vec4 const& v);

	/// Convert a packed integer to a normalized floating-point vector.
	///
	/// @see gtc_packing
	/// @see uint16 packUnorm3x5_1x1(vec4 const& v)
	ASTER_LINEAR_FUNC_DECL vec4 unpackUnorm3x5_1x1(uint16 p);

	/// Convert each component of the normalized floating-point vector into unsigned integer values.
	///
	/// @see gtc_packing
	/// @see vec3 unpackUnorm2x3_1x2(uint8 p)
	ASTER_LINEAR_FUNC_DECL uint8 packUnorm2x3_1x2(vec3 const& v);

	/// Convert a packed integer to a normalized floating-point vector.
	///
	/// @see gtc_packing
	/// @see uint8 packUnorm2x3_1x2(vec3 const& v)
	ASTER_LINEAR_FUNC_DECL vec3 unpackUnorm2x3_1x2(uint8 p);
	...
	ASTER_LINEAR_FUNC_DECL int16 packInt2x8(i8vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int16 packInt2x8(i8vec2 const& v)
	ASTER_LINEAR_FUNC_DECL i8vec2 unpackInt2x8(int16 p);

	/// Convert each component from an integer vector into a packed unsigned integer.
	///
	/// @see gtc_packing
	/// @see u8vec2 unpackInt2x8(uint16 p)
	ASTER_LINEAR_FUNC_DECL uint16 packUint2x8(u8vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see uint16 packInt2x8(u8vec2 const& v)
	ASTER_LINEAR_FUNC_DECL u8vec2 unpackUint2x8(uint16 p);

	/// Convert each component from an integer vector into a packed integer.
	///
	/// @see gtc_packing
	/// @see i8vec4 unpackInt4x8(int32 p)
	ASTER_LINEAR_FUNC_DECL int32 packInt4x8(i8vec4 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int32 packInt2x8(i8vec4 const& v)
	ASTER_LINEAR_FUNC_DECL i8vec4 unpackInt4x8(int32 p);

	/// Convert each component from an integer vector into a packed unsigned integer.
	///
	/// @see gtc_packing
	/// @see u8vec4 unpackUint4x8(uint32 p)
	ASTER_LINEAR_FUNC_DECL uint32 packUint4x8(u8vec4 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see uint32 packUint4x8(u8vec2 const& v)
	ASTER_LINEAR_FUNC_DECL u8vec4 unpackUint4x8(uint32 p);

	/// Convert each component from an integer vector into a packed integer.
	///
	/// @see gtc_packing
	/// @see i16vec2 unpackInt2x16(int p)
	ASTER_LINEAR_FUNC_DECL int packInt2x16(i16vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int packInt2x16(i16vec2 const& v)
	ASTER_LINEAR_FUNC_DECL i16vec2 unpackInt2x16(int p);

	/// Convert each component from an integer vector into a packed integer.
	///
	/// @see gtc_packing
	/// @see i16vec4 unpackInt4x16(int64 p)
	ASTER_LINEAR_FUNC_DECL int64 packInt4x16(i16vec4 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int64 packInt4x16(i16vec4 const& v)
	ASTER_LINEAR_FUNC_DECL i16vec4 unpackInt4x16(int64 p);

	/// Convert each component from an integer vector into a packed unsigned integer.
	///
	/// @see gtc_packing
	/// @see u16vec2 unpackUint2x16(uint p)
	ASTER_LINEAR_FUNC_DECL uint packUint2x16(u16vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see uint packUint2x16(u16vec2 const& v)
	ASTER_LINEAR_FUNC_DECL u16vec2 unpackUint2x16(uint p);

	/// Convert each component from an integer vector into a packed unsigned integer.
	///
	/// @see gtc_packing
	/// @see u16vec4 unpackUint4x16(uint64 p)
	ASTER_LINEAR_FUNC_DECL uint64 packUint4x16(u16vec4 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see uint64 packUint4x16(u16vec4 const& v)
	ASTER_LINEAR_FUNC_DECL u16vec4 unpackUint4x16(uint64 p);

	/// Convert each component from an integer vector into a packed integer.
	///
	/// @see gtc_packing
	/// @see i32vec2 unpackInt2x32(int p)
	ASTER_LINEAR_FUNC_DECL int64 packInt2x32(i32vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int packInt2x16(i32vec2 const& v)
	ASTER_LINEAR_FUNC_DECL i32vec2 unpackInt2x32(int64 p);

	/// Convert each component from an integer vector into a packed unsigned integer.
	///
	/// @see gtc_packing
	/// @see u32vec2 unpackUint2x32(int p)
	ASTER_LINEAR_FUNC_DECL uint64 packUint2x32(u32vec2 const& v);

	/// Convert a packed integer into an integer vector.
	///
	/// @see gtc_packing
	/// @see int packUint2x16(u32vec2 const& v)
	ASTER_LINEAR_FUNC_DECL u32vec2 unpackUint2x32(uint64 p);
