/// @ref core
/// @file aster_linear/linear.hpp
///
/// @defgroup core Core features
///
/// @brief Features that implement in C++ the GLSL specification as closely as possible.
///
/// The ASTER_LINEAR core consists of C++ types that mirror GLSL types and
...
/// including <aster_linear/ext.hpp>. Otherwise, each extension needs to be included  a specific file.
///
///
