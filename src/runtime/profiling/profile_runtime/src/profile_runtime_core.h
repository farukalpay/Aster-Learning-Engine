...
#include "profile_runtime_serialization.h"

#include "profile_runtime_gpu.h"

#include <atomic>

// We expect to have 1k unique strings going through ProfileRuntime at once
...
{
	template<>
	struct hash<ProfileRuntime::StringHash>
	{
		size_t operator()(const ProfileRuntime::StringHash& x) const
		{
...
#endif //PROFILE_RUNTIME_MSVC
template<int N>
struct ProfileRuntimeString
{
	char data[N];
	ProfileRuntimeString() {}
	ProfileRuntimeString<N>& operator=(const char* text) { strncpy(data, text ? text : "null", N - 1); data[N - 1] = 0; return *this; }
	ProfileRuntimeString(const char* text) { *this = text; }
	ProfileRuntimeString(const char* text, uint16_t length) { uint16_t maxLength = std::min((uint16_t)(N - 1), length); strncpy(data, text ? text : "null", maxLength); data[maxLength] = 0; }
};
#if defined(PROFILE_RUNTIME_MSVC)
#pragma warning( pop )
#endif
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template<int N>
OutputDataStream& operator<<(OutputDataStream &stream, const ProfileRuntimeString<N>& ob)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
typedef ProfileRuntimeString<32> ShortString;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
struct EventStorage
{
	...
	PROFILE_RUNTIME_INLINE EventData& NextEvent() 
	{
...
public:
	...
	static PROFILE_RUNTIME_THREAD_LOCAL EventStorage* storage;
