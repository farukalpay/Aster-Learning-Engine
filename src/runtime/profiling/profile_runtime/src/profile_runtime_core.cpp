...
#include "profile_runtime_server.h"
...
#include "profile_runtime_core.win.h"
#elif defined(PROFILE_RUNTIME_LINUX)
#include "profile_runtime_core.linux.h"
#elif defined(PROFILE_RUNTIME_OSX)
#include "profile_runtime_core.macos.h"
#elif defined(PROFILE_RUNTIME_PS4)
#include "profile_runtime_core.ps4.h"
#elif defined(PROFILE_RUNTIME_FREEBSD)
#include "profile_runtime_core.freebsd.h"
#endif
//////////////////////////////////////////////////////////////////////////
// End of the Platform-specific stuff
//////////////////////////////////////////////////////////////////////////

extern "C" ProfileRuntime::EventData* NextEvent()
{
	if (ProfileRuntime::EventStorage* storage = ProfileRuntime::Core::storage)
	{
...
#if defined(PROFILE_RUNTIME_32BIT)
...
{
	PROFILE_RUNTIME_VERIFY(symbol, "Can't serialize NULL symbol!", return os);
...
{
	PROFILE_RUNTIME_FAILED("It is pointless to copy EventDescription. Please, check you logic!"); return *this;
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PROFILE_RUNTIME_INLINE PushEvent(EventStorage* pStorage, const EventDescription* description, int64_t timestampStart)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PROFILE_RUNTIME_INLINE PopEvent(EventStorage* pStorage, int64_t timestampFinish)
{
	if (EventStorage* storage = pStorage)
...
bool CallstackCollector::SerializeSymbols(OutputDataStream& stream)
{
	...
	for (CallstacksPool::const_iterator it = callstacksPool.begin(); it != callstacksPool.end();)
	{
		...
		PROFILE_RUNTIME_UNUSED(startIt);

		uint64 threadID = *it;
		PROFILE_RUNTIME_UNUSED(threadID);
		++it; //Skip ThreadID
		uint64 timestamp = *it;
		PROFILE_RUNTIME_UNUSED
		(timestamp);
		++it; //Skip Timestamp
		uint64 count = *it;
		count = (count & 0xFF);
...
#elif (defined(__ANDROID__) || defined(PROFILE_RUNTIME_ARM))
// Nothing
...
#elif defined(PROFILE_RUNTIME_ARM)
	#if defined(PROFILE_RUNTIME_ARM32)
		return "ARM 32-bit";
	#else
		return "ARM 64-bit";
	#endif
...
void Core::DumpThread(ThreadEntry& entry, const EventTime& timeSlice, ScopeData& scope)
{
	...
	PROFILE_RUNTIME_ASSERT(entry.storage.fiberSyncBuffer.IsEmpty(), "Fiber switch events in native threads?");
}
...
#if PROFILE_RUNTIME_ENABLE_TRACING
			if (mode & Mode::TRACER)
			{
				if (tracer == nullptr)
...
{
	PROFILE_RUNTIME_ASSERT(gpuProfiler == nullptr, "Can't reinitialize GPU profiler! Not supported yet!");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_THREAD_LOCAL EventStorage* Core::storage = nullptr;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API uint32_t BeginFrame(ProfileRuntime::FrameType::Type frameType, int64_t timestamp, uint64_t threadID)
{
	return Core::BeginFrame(frameType, timestamp != EventTime::INVALID_TIMESTAMP ? timestamp : ProfileRuntime::GetHighPrecisionTime(), threadID != INVALID_THREAD_ID ? threadID : Platform::GetThreadID());
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API uint32_t EndFrame(ProfileRuntime::FrameType::Type frameType, int64_t timestamp, uint64_t threadID)
{
	return Core::EndFrame(frameType, timestamp != EventTime::INVALID_TIMESTAMP ? timestamp : ProfileRuntime::GetHighPrecisionTime(), threadID != INVALID_THREAD_ID ? threadID : Platform::GetThreadID());
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API bool RegisterFiber(uint64 fiberId, EventStorage** slot)
{
	return Core::Get().RegisterFiber(FiberDescription(fiberId), slot);
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API EventStorage* RegisterStorage(const char* name, uint64_t threadID, ThreadMask::Type type)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API const EventDescription* GetFrameDescription(FrameType::Type frame)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PROFILE_RUNTIME_API bool SaveCapture(CaptureSaveChunkCb dataCb /*= nullptr*/, bool force /*= true*/)
{
