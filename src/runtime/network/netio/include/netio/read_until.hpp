#ifndef NETIO_READ_UNTIL_HPP
#define NETIO_READ_UNTIL_HPP
...
#include "netio/detail/regex_fwd.hpp"
...
# include "netio/basic_streambuf_fwd.hpp"
...
struct is_match_condition
{
  ...
  enum
  {
    value = netio::is_function<remove_pointer_t<T>>::value
...
/**
 * @defgroup read_until netio::read_until
 *
 ...
 * std::size_t n = netio::read_until(s,
 *     netio::dynamic_buffer(data), '\n');
...
std::size_t read_until(SyncReadStream& s,
    ...
    char delim, netio::error_code& ec,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    > = 0,
    constraint_t<
 ...
 * @code std::string data;
 * std::size_t n = netio::read_until(s,
 *     netio::dynamic_buffer(data), boost::regex("\r\n"));
 * std::string line = data.substr(0, n);
 * data.erase(0, n); @endcode
 * After the @c read_until operation completes successfully, the string @c data
 * contains the delimiter:
...
template <typename SyncReadStream, typename DynamicBuffer_v1, typename Traits>
std::size_t read_until(SyncReadStream& s, DynamicBuffer_v1&& buffers,
    const boost::basic_regex<char, Traits>& expr, netio::error_code& ec,
    constraint_t<
      is_dynamic_buffer_v1<decay_t<DynamicBuffer_v1>>::value
    > = 0,
    constraint_t<
 ...
 * @code typedef netio::buffers_iterator<
 *     netio::const_buffer> iterator;
 *
 ...
 * ...
 * std::string data;
 * netio::read_until(s, data, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * netio::read_until(s, data, match_char('a'));
 * @endcode
 */
...
std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v1&& buffers,
    MatchCondition match_condition, netio::error_code& ec,
    constraint_t<
      is_match_condition<MatchCondition>::value
    > = 0,
    constraint_t<
 ...
 * @code netio::streambuf b;
 * netio::read_until(s, b, '\n');
 * std::istream is(&b);
 * std::string line;
...
std::size_t read_until(SyncReadStream& s,
    netio::basic_streambuf<Allocator>& b, char delim);
...
template <typename SyncReadStream, typename Allocator>
std::size_t read_until(SyncReadStream& s,
    netio::basic_streambuf<Allocator>& b,
    NETIO_STRING_VIEW_PARAM delim);
...
std::size_t read_until(SyncReadStream& s,
    netio::basic_streambuf<Allocator>& b,
    NETIO_STRING_VIEW_PARAM delim, netio::error_code& ec);
 ...
 * @code netio::streambuf b;
 * netio::read_until(s, b, boost::regex("\r\n"));
 * std::istream is(&b);
 * std::string line;
 * std::getline(is, line); @endcode
 * After the @c read_until operation completes successfully, the buffer @c b
 ...
 * @code typedef netio::buffers_iterator<
 *     netio::streambuf::const_buffers_type> iterator;
 *
 * std::pair<iterator, bool>
 * match_whitespace(iterator begin, iterator end)
 * {
 ...
 * ...
 * netio::streambuf b;
 * netio::read_until(s, b, match_whitespace);
 * @endcode
 *
 ...
 * ...
 * netio::streambuf b;
 * netio::read_until(s, b, match_char('a'));
 * @endcode
 */
template <typename SyncReadStream, typename Allocator, typename MatchCondition>
std::size_t read_until(SyncReadStream& s,
    netio::basic_streambuf<Allocator>& b, MatchCondition match_condition,
...
/*@}*/
/**
 * @defgroup async_read_until netio::async_read_until
 *
 ...
 * @code std::string data;
 * ...
 * void handler(const netio::error_code& e, std::size_t size)
 * {
 *   if (!e)
 *   {
 *     std::string line = data.substr(0, n);
 ...
 * ...
 * std::string data;
 * netio::async_read_until(s, data, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * std::string data;
 * netio::async_read_until(s, data, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
 ...
 * }
 * ...
 * netio::async_read_until(s, b, boost::regex("\r\n"), handler); @endcode
 * After the @c async_read_until operation completes successfully, the buffer
 ...
 * ...
 * netio::streambuf b;
 * netio::async_read_until(s, b, match_whitespace, handler);
 * @endcode
 *
 ...
 * ...
 * netio::streambuf b;
 * netio::async_read_until(s, b, match_char('a'), handler);
 * @endcode
 *
 * @par Per-Operation Cancellation
 * This asynchronous operation supports cancellation for the following
...
#include "netio/impl/read_until.hpp"

#endif // NETIO_READ_UNTIL_HPP
