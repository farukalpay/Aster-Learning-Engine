#ifndef NETIO_EXPERIMENTAL_AS_SINGLE_HPP
#define NETIO_EXPERIMENTAL_AS_SINGLE_HPP
...
#include "netio/experimental/impl/as_single.hpp"

#endif // NETIO_EXPERIMENTAL_AS_SINGLE_HPP
