#ifndef NETIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP
#define NETIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP
...
#include "netio/detail/initiate_post.hpp"
#include "netio/detail/initiate_dispatch.hpp"
...
class channel_operation NETIO_INHERIT_TRACKED_HANDLER
{
public:
...
protected:
  ...
  friend class netio::detail::op_queue_access;
...
public:
  ...
  handler_work_base(int, const Executor& ex)
    : executor_(netio::prefer(ex, execution::outstanding_work.tracked))
  {
  }
  ...
  {
    (netio::detail::initiate_post_with_executor<IoExecutor>(io_exec))(
        static_cast<Function&&>(function),
        netio::detail::empty_work_function());
  }
...
public:
  ...
  void post(const IoExecutor&, Function& function, Handler& handler)
  {
    ...
    netio::prefer(
        netio::require(executor_, execution::blocking.never),
        execution::allocator(allocator)
      ).execute(static_cast<Function&&>(function));
  }
...
public:
  ...
  void immediate(Function& function, Handler& handler, ...)
  {
    ...
    (netio::detail::initiate_dispatch_with_executor<
  ...
  void immediate(Function& function, Handler&,
      ...
      >*)
  {
    (netio::detail::initiate_post_with_executor<
        typename base1_type::executor_type>(
    ...
    enable_if_t<
      is_same<
        typename associated_executor<Handler,
          IoExecutor>::netio_associated_executor_is_unspecialised,
        void
      >::value
    >
...
#endif // NETIO_EXPERIMENTAL_DETAIL_CHANNEL_OPERATION_HPP
