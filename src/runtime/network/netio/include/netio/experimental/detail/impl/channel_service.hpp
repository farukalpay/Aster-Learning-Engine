#ifndef NETIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
#define NETIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
...
inline channel_service<Mutex>::channel_service(
  ...
  : netio::detail::execution_context_service_base<channel_service>(ctx),
    mutex_(),
    impl_list_(0)
{
}
...
inline void channel_service<Mutex>::shutdown()
{
  ...
  netio::detail::op_queue<channel_operation> ops;
    ...
    void* cancellation_key)
{
  ...
  netio::detail::op_queue<channel_operation> other_ops;
  while (channel_operation* op = impl.waiters_.front())
  {
  ...
  case buffer:
    {
      ...
      lock.unlock();
      netio::detail::non_const_lvalue<Handler> handler2(handler);
      netio::detail::completion_payload_handler<
...
#endif // NETIO_EXPERIMENTAL_DETAIL_IMPL_CHANNEL_SERVICE_HPP
