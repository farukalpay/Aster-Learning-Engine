#ifndef NETIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
#define NETIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
...
#endif // NETIO_EXPERIMENTAL_DETAIL_CORO_PROMISE_ALLOCATOR_HPP
