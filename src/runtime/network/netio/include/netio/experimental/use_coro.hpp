#ifndef NETIO_EXPERIMENTAL_USE_CORO_HPP
#define NETIO_EXPERIMENTAL_USE_CORO_HPP
 ...
 * token @c netio::deferred for that) but does provide type erasure, as it
...
# else // defined(NETIO_HAS_SOURCE_LOCATION)
    , file_name_(0),
      line_(0),
      function_name_(0)
# endif // defined(NETIO_HAS_SOURCE_LOCATION)
...
/// resumable coroutine.
/**
 * See the documentation for netio::use_coro_t for a usage example.
 */
#if defined(GENERATING_DOCUMENTATION)
NETIO_INLINE_VARIABLE constexpr use_coro_t<> use_coro;
#else
NETIO_INLINE_VARIABLE constexpr use_coro_t<> use_coro(0, 0, 0);
#endif
...
#include "netio/experimental/impl/use_coro.hpp"
#include "netio/experimental/coro.hpp"

#endif // NETIO_EXPERIMENTAL_USE_CORO_HPP
