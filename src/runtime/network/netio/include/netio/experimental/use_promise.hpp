#ifndef NETIO_EXPERIMENTAL_USE_PROMISE_HPP
#define NETIO_EXPERIMENTAL_USE_PROMISE_HPP
...
NETIO_INLINE_VARIABLE constexpr use_promise_t<> use_promise;
...
#include "netio/experimental/impl/use_promise.hpp"
