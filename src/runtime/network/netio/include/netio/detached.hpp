#ifndef NETIO_DETACHED_HPP
#define NETIO_DETACHED_HPP
 ...
 * @c netio::detached. For example:
 *
 * @code my_socket.async_send(my_buffer, netio::detached);
 * @endcode
 */
class detached_t
{
...
/**
 * See the documentation for netio::detached_t for a usage example.
 */
NETIO_INLINE_VARIABLE constexpr detached_t detached;

} // namespace netio

#include "netio/detail/pop_options.hpp"

#include "netio/impl/detached.hpp"

#endif // NETIO_DETACHED_HPP
