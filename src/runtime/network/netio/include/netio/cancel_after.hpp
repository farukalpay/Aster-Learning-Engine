#ifndef NETIO_CANCEL_AFTER_HPP
#define NETIO_CANCEL_AFTER_HPP
...
NETIO_NODISCARD inline partial_cancel_after<chrono::steady_clock>
...
#include "netio/impl/cancel_after.hpp"

#endif // NETIO_CANCEL_AFTER_HPP
