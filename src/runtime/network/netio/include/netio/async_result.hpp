#ifndef NETIO_ASYNC_RESULT_HPP
#define NETIO_ASYNC_RESULT_HPP
...
NETIO_CONCEPT callable_with = requires(T&& t, Args&&... args)
{
...
template <typename T>
NETIO_CONCEPT completion_signature =
  detail::is_completion_signature<T>::value;

#define NETIO_COMPLETION_SIGNATURE \
  ::netio::completion_signature

template <typename T, typename... Signatures>
NETIO_CONCEPT completion_handler_for =
  detail::are_completion_signatures<Signatures...>::value
    && detail::is_completion_handler_for<T, Signatures...>::value;

#define NETIO_COMPLETION_HANDLER_FOR(sig) \
  ::netio::completion_handler_for<sig>
#define NETIO_COMPLETION_HANDLER_FOR2(sig0, sig1) \
  ::netio::completion_handler_for<sig0, sig1>
#define NETIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) \
  ::netio::completion_handler_for<sig0, sig1, sig2>

#else // defined(NETIO_HAS_CONCEPTS)

#define NETIO_COMPLETION_SIGNATURE typename
#define NETIO_COMPLETION_HANDLER_FOR(sig) typename
#define NETIO_COMPLETION_HANDLER_FOR2(sig0, sig1) typename
#define NETIO_COMPLETION_HANDLER_FOR3(sig0, sig1, sig2) typename
...
template <typename CompletionToken,
    NETIO_COMPLETION_SIGNATURE... Signatures>
...
public:
  ...
  template <typename Initiation,
      NETIO_COMPLETION_HANDLER_FOR(Signatures...) RawCompletionToken,
      typename... Args>
...
template <NETIO_COMPLETION_SIGNATURE... Signatures>
...
struct async_completion
{
  ...
  typedef typename netio::async_result<
...
#if defined(GENERATING_DOCUMENTATION)
# define NETIO_INITFN_RESULT_TYPE(ct, sig) \
  void_or_deduced
# define NETIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  void_or_deduced
# define NETIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  void_or_deduced
#else
# define NETIO_INITFN_RESULT_TYPE(ct, sig) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, sig>::return_type
# define NETIO_INITFN_RESULT_TYPE2(ct, sig0, sig1) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, sig0, sig1>::return_type
# define NETIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, sig0, sig1, sig2>::return_type
#define NETIO_HANDLER_TYPE(ct, sig) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, sig>::completion_handler_type
#define NETIO_HANDLER_TYPE2(ct, sig0, sig1) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, \
      sig0, sig1>::completion_handler_type
#define NETIO_HANDLER_TYPE3(ct, sig0, sig1, sig2) \
  typename ::netio::async_result< \
    typename ::netio::decay<ct>::type, \
...
#if defined(GENERATING_DOCUMENTATION)
# define NETIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  auto
#elif defined(NETIO_HAS_RETURN_TYPE_DEDUCTION)
# define NETIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  auto
...
#else
# define NETIO_INITFN_AUTO_RESULT_TYPE(ct, sig) \
  NETIO_INITFN_RESULT_TYPE(ct, sig)
# define NETIO_INITFN_AUTO_RESULT_TYPE2(ct, sig0, sig1) \
  NETIO_INITFN_RESULT_TYPE2(ct, sig0, sig1)
# define NETIO_INITFN_AUTO_RESULT_TYPE3(ct, sig0, sig1, sig2) \
  NETIO_INITFN_RESULT_TYPE3(ct, sig0, sig1, sig2)
#endif

#if defined(GENERATING_DOCUMENTATION)
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ct, sig) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX2(ct, sig0, sig1) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX3(ct, sig0, sig1, sig2) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE_SUFFIX(expr)
#elif defined(NETIO_HAS_RETURN_TYPE_DEDUCTION)
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ct, sig) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX2(ct, sig0, sig1) \
...
# define NETIO_INITFN_AUTO_RESULT_TYPE_PREFIX3(ct, sig0, sig1, sig2) \
  auto
# define NETIO_INITFN_AUTO_RESULT_TYPE_SUFFIX(expr) -> decltype expr
#endif

#if defined(GENERATING_DOCUMENTATION)
# define NETIO_INITFN_DEDUCED_RESULT_TYPE(ct, sig, expr) \
  void_or_deduced
# define NETIO_INITFN_DEDUCED_RESULT_TYPE2(ct, sig0, sig1, expr) \
  void_or_deduced
# define NETIO_INITFN_DEDUCED_RESULT_TYPE3(ct, sig0, sig1, sig2, expr) \
  void_or_deduced
#else
# define NETIO_INITFN_DEDUCED_RESULT_TYPE(ct, sig, expr) \
  decltype expr
...
template <typename T, typename... Signatures>
NETIO_CONCEPT completion_token_for =
  detail::are_completion_signatures<Signatures...>::value
  &&
  requires(T&& t)
  {
...
#define NETIO_COMPLETION_TOKEN_FOR(sig) \
  ::netio::completion_token_for<sig>
#define NETIO_COMPLETION_TOKEN_FOR2(sig0, sig1) \
  ::netio::completion_token_for<sig0, sig1>
#define NETIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) \
  ::netio::completion_token_for<sig0, sig1, sig2>

#else // defined(NETIO_HAS_CONCEPTS)

#define NETIO_COMPLETION_TOKEN_FOR(sig) typename
#define NETIO_COMPLETION_TOKEN_FOR2(sig0, sig1) typename
#define NETIO_COMPLETION_TOKEN_FOR3(sig0, sig1, sig2) typename
...
template <typename T, typename... Args>
NETIO_CONCEPT async_operation = is_async_operation<T, Args...>::value;

#define NETIO_ASYNC_OPERATION \
  ::netio::async_operation
#define NETIO_ASYNC_OPERATION1(a0) \
  ::netio::async_operation<a0>
#define NETIO_ASYNC_OPERATION2(a0, a1) \
  ::netio::async_operation<a0, a1>
#define NETIO_ASYNC_OPERATION3(a0, a1, a2) \
  ::netio::async_operation<a0, a1, a2>

#else // defined(NETIO_HAS_CONCEPTS)

#define NETIO_ASYNC_OPERATION typename
#define NETIO_ASYNC_OPERATION1(a0) typename
#define NETIO_ASYNC_OPERATION2(a0, a1) typename
#define NETIO_ASYNC_OPERATION3(a0, a1, a2) typename
