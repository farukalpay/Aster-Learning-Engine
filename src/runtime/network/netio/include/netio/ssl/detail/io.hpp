#ifndef NETIO_SSL_DETAIL_IO_HPP
#define NETIO_SSL_DETAIL_IO_HPP
...
std::size_t io(Stream& next_layer, stream_core& core,
    const Operation& op, netio::error_code& ec)
{
  netio::error_code io_ec;
  ...
  case engine::want_input_and_retry:
    ...
    {
      core.input_ = netio::buffer(core.input_buffer_,
...
class io_op
  : public netio::detail::base_from_cancellation_state<Handler>
{
public:
  io_op(Stream& next_layer, stream_core& core,
      const Operation& op, Handler& handler)
    : netio::detail::base_from_cancellation_state<Handler>(handler),
  ...
  io_op(const io_op& other)
    : netio::detail::base_from_cancellation_state<Handler>(other),
  ...
  io_op(io_op&& other)
    : netio::detail::base_from_cancellation_state<Handler>(
        static_cast<
          netio::detail::base_from_cancellation_state<Handler>&&>(other)),
      next_layer_(other.next_layer_),
      core_(other.core_),
      ...
      do
      {
        ...
        case engine::want_input_and_retry:
          ...
          if (core_.expiry(core_.pending_read_) == core_.neg_infin())
          {
            ...
            next_layer_.async_read_some(
                netio::buffer(core_.input_buffer_),
        ...
        default:
          ...
          if (start)
          {
            ...
            next_layer_.async_read_some(
                netio::buffer(core_.input_buffer_, 0),
                static_cast<io_op&&>(*this));
        ...
        case engine::want_input_and_retry:
          ...
          {
            ec_ = netio::error::operation_aborted;
            break;
          }
    ...
    io_op<Stream, Operation, Handler>* this_handler)
{
  return this_handler->start_ == 0 ? true
    : netio_handler_cont_helpers::is_continuation(this_handler->handler_);
}
