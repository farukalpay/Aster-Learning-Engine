#ifndef NETIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
#define NETIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
...
public:
  do_init()
  {
    ...
    for (size_t i = 0; i < mutexes_.size(); ++i)
      mutexes_[i].reset(new netio::detail::mutex);
...
private:
  ...
  static unsigned long openssl_id_func()
  {
    ...
    void* id = &errno;
    NETIO_ASSERT(sizeof(unsigned long) >= sizeof(void*));
  ...
  std::vector<netio::detail::shared_ptr<
        netio::detail::mutex>> mutexes_;
#endif // (OPENSSL_VERSION_NUMBER < 0x10100000L)
...
netio::detail::shared_ptr<openssl_init_base::do_init>
openssl_init_base::instance()
{
  static netio::detail::shared_ptr<do_init> init(new do_init);
  return init;
}
...
#endif // NETIO_SSL_DETAIL_IMPL_OPENSSL_INIT_IPP
