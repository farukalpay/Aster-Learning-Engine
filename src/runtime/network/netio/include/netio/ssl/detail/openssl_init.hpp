#ifndef NETIO_SSL_DETAIL_OPENSSL_INIT_HPP
#define NETIO_SSL_DETAIL_OPENSSL_INIT_HPP
...
protected:
  ...
  NETIO_DECL static netio::detail::shared_ptr<do_init> instance();

#if !defined(SSL_OP_NO_COMPRESSION) \
  && (OPENSSL_VERSION_NUMBER >= 0x00908000L)
  // Get an empty stack of compression methods, to be used when disabling
  // compression.
  NETIO_DECL static STACK_OF(SSL_COMP)* get_null_compression_methods();
...
private:
  ...
  netio::detail::shared_ptr<do_init> ref_;
};
...
#endif // NETIO_SSL_DETAIL_OPENSSL_INIT_HPP
