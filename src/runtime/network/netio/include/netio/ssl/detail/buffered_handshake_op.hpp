#ifndef NETIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
#define NETIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
...
public:
  ...
  buffered_handshake_op(stream_base::handshake_type type,
    ...
    : type_(type),
      buffers_(buffers),
      total_buffer_size_(netio::buffer_size(buffers_))
  {
  }
      ...
      std::size_t& bytes_transferred) const
  {
    return this->process(eng, ec, bytes_transferred,
        netio::buffer_sequence_begin(buffers_),
        netio::buffer_sequence_end(buffers_));
  }
...
#endif // NETIO_SSL_DETAIL_BUFFERED_HANDSHAKE_OP_HPP
