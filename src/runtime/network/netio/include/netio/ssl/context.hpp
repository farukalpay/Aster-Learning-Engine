#ifndef NETIO_SSL_CONTEXT_HPP
#define NETIO_SSL_CONTEXT_HPP
...
public:
  ...
  /// Constructor.
  NETIO_DECL explicit context(method m);

  /// Construct to take ownership of a native handle.
  NETIO_DECL explicit context(native_handle_type native_handle);
   ...
   */
  NETIO_DECL context(context&& other);
   ...
   * @li As a target for move-assignment.
   */
  NETIO_DECL context& operator=(context&& other);
   ...
   */
  NETIO_DECL native_handle_type native_handle();
   ...
   */
  NETIO_DECL void clear_options(options o);
   ...
   * @note Calls @c SSL_CTX_clear_options.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID clear_options(options o,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void set_options(options o);
   ...
   * @note Calls @c SSL_CTX_set_options.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID set_options(options o,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void set_verify_mode(verify_mode v);
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID set_verify_mode(
   ...
   */
  NETIO_DECL void set_verify_depth(int depth);
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID set_verify_depth(
   ...
   */
  template <typename VerifyCallback>
  NETIO_SYNC_OP_VOID set_verify_callback(VerifyCallback callback,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void load_verify_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID load_verify_file(
      const std::string& filename, netio::error_code& ec);
   ...
   */
  NETIO_DECL void add_certificate_authority(const const_buffer& ca);
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID add_certificate_authority(
      const const_buffer& ca, netio::error_code& ec);
   ...
   */
  NETIO_DECL void set_default_verify_paths();
   ...
   * @note Calls @c SSL_CTX_set_default_verify_paths.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID set_default_verify_paths(
      netio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  NETIO_DECL void add_verify_path(const std::string& path);
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID add_verify_path(
      const std::string& path, netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_certificate(
   ...
   * @note Calls @c SSL_CTX_use_certificate or SSL_CTX_use_certificate_ASN1.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_certificate(
      const const_buffer& certificate, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_certificate_file(
   ...
   * @note Calls @c SSL_CTX_use_certificate_file.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_certificate_file(
      const std::string& filename, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_certificate_chain(const const_buffer& chain);
   ...
   * @note Calls @c SSL_CTX_use_certificate and SSL_CTX_add_extra_chain_cert.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_certificate_chain(
      const const_buffer& chain, netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_certificate_chain_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_certificate_chain_file(
      const std::string& filename, netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_private_key(
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey or SSL_CTX_use_PrivateKey_ASN1.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_private_key(
      const const_buffer& private_key, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_private_key_file(
      const std::string& filename, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_PrivateKey_file.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_private_key_file(
      const std::string& filename, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_rsa_private_key(
      const const_buffer& private_key, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey or SSL_CTX_use_RSAPrivateKey_ASN1.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_rsa_private_key(
      const const_buffer& private_key, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_rsa_private_key_file(
      const std::string& filename, file_format format);
   ...
   * @note Calls @c SSL_CTX_use_RSAPrivateKey_file.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_rsa_private_key_file(
      const std::string& filename, file_format format,
      netio::error_code& ec);
   ...
   */
  NETIO_DECL void use_tmp_dh(const const_buffer& dh);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_tmp_dh(
      const const_buffer& dh, netio::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  NETIO_DECL void use_tmp_dh_file(const std::string& filename);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  NETIO_DECL NETIO_SYNC_OP_VOID use_tmp_dh_file(
      const std::string& filename, netio::error_code& ec);
   ...
   */
  template <typename PasswordCallback>
  NETIO_SYNC_OP_VOID set_password_callback(PasswordCallback callback,
      netio::error_code& ec);
...
private:
  ...
  NETIO_DECL NETIO_SYNC_OP_VOID do_set_verify_callback(
      detail::verify_callback_base* callback, netio::error_code& ec);
  ...
  NETIO_DECL NETIO_SYNC_OP_VOID do_set_password_callback(
      detail::password_callback_base* callback, netio::error_code& ec);

  // Callback used when the SSL implementation wants a password.
  NETIO_DECL static int password_callback_function(
      char* buf, int size, int purpose, void* data);

  // Helper function to set the temporary Diffie-Hellman parameters from a BIO.
  NETIO_DECL NETIO_SYNC_OP_VOID do_use_tmp_dh(
      BIO* bio, netio::error_code& ec);

  // Helper function to make a BIO from a memory buffer.
  NETIO_DECL BIO* make_buffer_bio(const const_buffer& b);

  // Translate an SSL error into an error code.
  NETIO_DECL static netio::error_code translate_error(long error);

  // The underlying native implementation.
  native_handle_type handle_;

  // Ensure openssl is initialised.
  netio::ssl::detail::openssl_init<> init_;
};
