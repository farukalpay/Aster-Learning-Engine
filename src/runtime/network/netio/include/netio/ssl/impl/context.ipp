#ifndef NETIO_SSL_IMPL_CONTEXT_IPP
#define NETIO_SSL_IMPL_CONTEXT_IPP
  ...
  : handle_(0)
{
  ...
  case context::sslv2_server:
    netio::detail::throw_error(
        netio::error::invalid_argument, "context");
    break;
  ...
  if (handle_ == 0)
  {
    netio::error_code ec = translate_error(::ERR_get_error());
    netio::detail::throw_error(ec, "context");
  }
...
void context::clear_options(context::options o)
{
  netio::error_code ec;
  clear_options(o, ec);
  netio::detail::throw_error(ec, "clear_options");
}

NETIO_SYNC_OP_VOID context::clear_options(
    context::options o, netio::error_code& ec)
{
...
void context::set_options(context::options o)
{
  netio::error_code ec;
  set_options(o, ec);
  netio::detail::throw_error(ec, "set_options");
}

NETIO_SYNC_OP_VOID context::set_options(
    context::options o, netio::error_code& ec)
{
#if !defined(SSL_OP_NO_COMPRESSION)
  if ((o & context::no_compression) != 0)
  {
    ...
    handle_->comp_methods =
      netio::ssl::detail::openssl_init<>::get_null_compression_methods();
#endif // (OPENSSL_VERSION_NUMBER >= 0x00908000L)
    o ^= context::no_compression;
  }
#endif // !defined(SSL_OP_NO_COMPRESSION)
...
void context::set_verify_mode(verify_mode v)
{
  ...
  netio::detail::throw_error(ec, "set_verify_mode");
}

NETIO_SYNC_OP_VOID context::set_verify_mode(
...
void context::set_verify_depth(int depth)
{
  ...
  netio::detail::throw_error(ec, "set_verify_depth");
}

NETIO_SYNC_OP_VOID context::set_verify_depth(
...
void context::load_verify_file(const std::string& filename)
{
  ...
  netio::detail::throw_error(ec, "load_verify_file");
}

NETIO_SYNC_OP_VOID context::load_verify_file(
...
void context::add_certificate_authority(const const_buffer& ca)
{
  ...
  netio::detail::throw_error(ec, "add_certificate_authority");
}

NETIO_SYNC_OP_VOID context::add_certificate_authority(
...
void context::set_default_verify_paths()
{
  ...
  netio::detail::throw_error(ec, "set_default_verify_paths");
}

NETIO_SYNC_OP_VOID context::set_default_verify_paths(
    netio::error_code& ec)
{
  ::ERR_clear_error();
...
void context::add_verify_path(const std::string& path)
{
  ...
  netio::detail::throw_error(ec, "add_verify_path");
}

NETIO_SYNC_OP_VOID context::add_verify_path(
    ...
    const const_buffer& certificate, file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_certificate");
}

NETIO_SYNC_OP_VOID context::use_certificate(
    const const_buffer& certificate, file_format format,
    netio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_certificate_file");
}

NETIO_SYNC_OP_VOID context::use_certificate_file(
    const std::string& filename, file_format format,
    netio::error_code& ec)
{
  int file_type;
...
void context::use_certificate_chain(const const_buffer& chain)
{
  ...
  netio::detail::throw_error(ec, "use_certificate_chain");
}

NETIO_SYNC_OP_VOID context::use_certificate_chain(
...
void context::use_certificate_chain_file(const std::string& filename)
{
  ...
  netio::detail::throw_error(ec, "use_certificate_chain_file");
}

NETIO_SYNC_OP_VOID context::use_certificate_chain_file(
    const std::string& filename, netio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_private_key");
}

NETIO_SYNC_OP_VOID context::use_private_key(
    const const_buffer& private_key, context::file_format format,
    netio::error_code& ec)
{
  ::ERR_clear_error();
    ...
    const std::string& filename, context::file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_private_key_file");
}
    ...
    const const_buffer& private_key, context::file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_rsa_private_key");
}

NETIO_SYNC_OP_VOID context::use_rsa_private_key(
    const const_buffer& private_key, context::file_format format,
    netio::error_code& ec)
{
  ::ERR_clear_error();
...
NETIO_SYNC_OP_VOID context::use_private_key_file(
    const std::string& filename, context::file_format format,
    netio::error_code& ec)
{
  int file_type;
    ...
    const std::string& filename, context::file_format format)
{
  ...
  netio::detail::throw_error(ec, "use_rsa_private_key_file");
}

NETIO_SYNC_OP_VOID context::use_rsa_private_key_file(
    const std::string& filename, context::file_format format,
    netio::error_code& ec)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
...
void context::use_tmp_dh(const const_buffer& dh)
{
  netio::error_code ec;
  use_tmp_dh(dh, ec);
  netio::detail::throw_error(ec, "use_tmp_dh");
}

NETIO_SYNC_OP_VOID context::use_tmp_dh(
...
void context::use_tmp_dh_file(const std::string& filename)
{
  ...
  netio::detail::throw_error(ec, "use_tmp_dh_file");
}

NETIO_SYNC_OP_VOID context::use_tmp_dh_file(
    const std::string& filename, netio::error_code& ec)
{
  ::ERR_clear_error();
...
NETIO_SYNC_OP_VOID context::do_use_tmp_dh(
...
NETIO_SYNC_OP_VOID context::do_set_verify_callback(
...
NETIO_SYNC_OP_VOID context::do_set_password_callback(
...
netio::error_code context::translate_error(long error)
{
#if (OPENSSL_VERSION_NUMBER >= 0x30000000L)
  ...
  return netio::error_code(static_cast<int>(error),
...
#endif // NETIO_SSL_IMPL_CONTEXT_IPP
