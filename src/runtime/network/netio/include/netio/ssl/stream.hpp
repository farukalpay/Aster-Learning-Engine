#ifndef NETIO_SSL_STREAM_HPP
#define NETIO_SSL_STREAM_HPP
...
#include "netio/ssl/detail/buffered_handshake_op.hpp"
#include "netio/ssl/detail/handshake_op.hpp"
#include "netio/ssl/detail/io.hpp"
#include "netio/ssl/detail/read_op.hpp"
#include "netio/ssl/detail/shutdown_op.hpp"
#include "netio/ssl/detail/stream_core.hpp"
#include "netio/ssl/detail/write_op.hpp"
 ...
 * @code
 * netio::io_context my_context;
 * netio::ssl::context ctx(netio::ssl::context::sslv23);
 * netio::ssl::stream<netio::ip::tcp::socket> sock(my_context, ctx);
 * @endcode
 *
 * @par Concepts:
...
public:
   ...
   * @code
   * netio::ssl::stream<netio::ip::tcp::socket> sock(io_ctx, ctx);
   *
   ...
   * @note Calls @c SSL_set_verify.
   */
  NETIO_SYNC_OP_VOID set_verify_mode(
   ...
   * @note Calls @c SSL_set_verify_depth.
   */
  NETIO_SYNC_OP_VOID set_verify_depth(
  ...
  void handshake(handshake_type type)
  {
    netio::error_code ec;
    handshake(type, ec);
    netio::detail::throw_error(ec, "handshake");
  }
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  NETIO_SYNC_OP_VOID handshake(handshake_type type,
      netio::error_code& ec)
  {
   ...
   *
   * @par Completion Signature
   * @code void(netio::error_code, std::size_t) @endcode
   *
   * @par Per-Operation Cancellation
   * This asynchronous operation supports cancellation for the following
   * netio::cancellation_type values:
   ...
   * @param ec Set to indicate what error occurred, if any.
   */
  NETIO_SYNC_OP_VOID shutdown(netio::error_code& ec)
  {
  ...
  std::size_t write_some(const ConstBufferSequence& buffers)
  {
    ...
    netio::detail::throw_error(ec, "write_some");
    return n;
  }
  ...
  std::size_t read_some(const MutableBufferSequence& buffers)
  {
    ...
    netio::detail::throw_error(ec, "read_some");
    return n;
  }
...
private:
  ...
  public:
        ...
        handshake_type type) const
    {
      ...
      NETIO_HANDSHAKE_HANDLER_CHECK(HandshakeHandler, handler) type_check;

      netio::detail::non_const_lvalue<HandshakeHandler> handler2(handler);
  ...
  public:
        ...
        handshake_type type, const ConstBufferSequence& buffers) const
    {
      ...
      NETIO_BUFFERED_HANDSHAKE_HANDLER_CHECK(
          BufferedHandshakeHandler, handler) type_check;

      netio::detail::non_const_lvalue<
  ...
  public:
    ...
    void operator()(ShutdownHandler&& handler) const
    {
      ...
      NETIO_HANDSHAKE_HANDLER_CHECK(ShutdownHandler, handler) type_check;

      netio::detail::non_const_lvalue<ShutdownHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const ConstBufferSequence& buffers) const
    {
      ...
      NETIO_WRITE_HANDLER_CHECK(WriteHandler, handler) type_check;

      netio::detail::non_const_lvalue<WriteHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
  ...
  public:
        ...
        const MutableBufferSequence& buffers) const
    {
      ...
      NETIO_READ_HANDLER_CHECK(ReadHandler, handler) type_check;

      netio::detail::non_const_lvalue<ReadHandler> handler2(handler);
      detail::async_io(self_->next_layer_, self_->core_,
