#ifndef NETIO_REQUIRE_HPP
#define NETIO_REQUIRE_HPP
 ...
 * expression <tt>netio::require(E, P0, Pn...)</tt> for some
 ...
 *   <tt>netio::require(E, P0, Pn...)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise,
 *   <tt>netio::require(netio::require(E, P0), Pn...)</tt>
 *   if <tt>N > 0</tt> and the expression
 *   <tt>netio::require(netio::require(E, P0), Pn...)</tt>
 *   is a valid expression.
 *
 * @li Otherwise, <tt>netio::require(E, P0, Pn...)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>netio::require(std::declval<T>(),
 ...
 * type of the expression <tt>netio::require(std::declval<T>(),
...
static constexpr const netio_require_fn::impl&
  require = netio_require_fn::static_instance<>::instance;

} // namespace

typedef netio_require_fn::impl require_t;

template <typename T, typename... Properties>
struct can_require :
  integral_constant<bool,
    netio_require_fn::call_traits<
      require_t, T, void(Properties...)>::overload
        != netio_require_fn::ill_formed>
{
};
...
struct require_result
{
  typedef typename netio_require_fn::call_traits<
