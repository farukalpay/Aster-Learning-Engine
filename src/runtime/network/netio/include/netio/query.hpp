#ifndef NETIO_QUERY_HPP
#define NETIO_QUERY_HPP
...
#include "netio/traits/query_member.hpp"
#include "netio/traits/query_free.hpp"
 ...
 * expression <tt>netio::query(E, P)</tt> for some
 ...
 *   constant expression with value <tt>true</tt>, <tt>netio::query(E,
 *   P)</tt> is ill-formed.
 *
 ...
 *
 * @li Otherwise, <tt>netio::query(E, P)</tt> is ill-formed.
 */
 ...
 * @c true_type if the expression <tt>netio::query(std::declval<T>(),
 ...
 * type of the expression <tt>netio::query(std::declval<T>(),
...
using netio::traits::query_free;
using netio::traits::query_member;
using netio::traits::static_query;
...
static constexpr const netio_query_fn::impl&
  query = netio_query_fn::static_instance<>::instance;

} // namespace

typedef netio_query_fn::impl query_t;

template <typename T, typename Property>
struct can_query :
  integral_constant<bool,
    netio_query_fn::call_traits<query_t, T, void(Property)>::overload !=
      netio_query_fn::ill_formed>
{
};
...
struct is_nothrow_query :
  integral_constant<bool,
    netio_query_fn::call_traits<query_t, T, void(Property)>::is_noexcept>
{
};
...
struct query_result
{
  typedef typename netio_query_fn::call_traits<
