#ifndef NETIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP
#define NETIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP
...
public:
...
#else
  typedef netio::detail::win_iocp_handle_service::native_handle_type
    native_handle_type;
#endif
   ...
   * netio::error::operation_aborted error. Ownership of the native handle
...
protected:
  ...
  netio::detail::io_object_impl<
    netio::detail::win_iocp_handle_service, Executor> impl_;
...
#endif // NETIO_WINDOWS_BASIC_OVERLAPPED_HANDLE_HPP
