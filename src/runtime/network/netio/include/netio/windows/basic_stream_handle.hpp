#ifndef NETIO_WINDOWS_BASIC_STREAM_HANDLE_HPP
#define NETIO_WINDOWS_BASIC_STREAM_HANDLE_HPP
...
public:
   ...
   * @code
   * handle.write_some(netio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_write_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * handle.read_some(netio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_read_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // NETIO_WINDOWS_BASIC_STREAM_HANDLE_HPP
