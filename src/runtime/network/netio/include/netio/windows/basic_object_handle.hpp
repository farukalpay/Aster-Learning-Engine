#ifndef NETIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
#define NETIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
...
#include "netio/detail/win_object_handle_service.hpp"
...
public:
...
#else
  typedef netio::detail::win_object_handle_service::native_handle_type
    native_handle_type;
#endif
   ...
   */
  NETIO_SYNC_OP_VOID assign(const native_handle_type& handle,
      netio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(), handle, ec);
...
private:
  ...
  netio::detail::io_object_impl<
    netio::detail::win_object_handle_service, Executor> impl_;
};
...
#endif // NETIO_WINDOWS_BASIC_OBJECT_HANDLE_HPP
