#ifndef NETIO_ANY_COMPLETION_HANDLER_HPP
#define NETIO_ANY_COMPLETION_HANDLER_HPP
  ...
  struct uninit_deleter
  {
    typename std::allocator_traits<
      associated_allocator_t<Handler,
        netio::recycling_allocator<void>>>::template
  ...
  static any_completion_handler_impl* create(S&& slot, H&& h)
  {
    uninit_deleter d{
        (get_associated_allocator)(h,
          netio::recycling_allocator<void>())};
...
#endif // NETIO_ANY_COMPLETION_HANDLER_HPP
