#ifndef NETIO_IMPL_EXECUTION_CONTEXT_HPP
#define NETIO_IMPL_EXECUTION_CONTEXT_HPP
...
template <typename Service>
NETIO_DEPRECATED_MSG("Use make_service()")
...
#endif // NETIO_IMPL_EXECUTION_CONTEXT_HPP
