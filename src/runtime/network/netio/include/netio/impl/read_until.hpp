#ifndef NETIO_IMPL_READ_UNTIL_HPP
#define NETIO_IMPL_READ_UNTIL_HPP
...
#include "netio/detail/base_from_cancellation_state.hpp"
    ...
    >)
{
  ...
  netio::detail::throw_error(ec, "read_until");
...
template <typename SyncReadStream, typename DynamicBuffer_v2>
inline std::size_t read_until(SyncReadStream& s,
    DynamicBuffer_v2 buffers, NETIO_STRING_VIEW_PARAM delim,
    constraint_t<
      is_dynamic_buffer_v2<DynamicBuffer_v2>::value
    >)
{
...
namespace detail
{
  ...
  public:
    ...
    void operator()(netio::error_code ec,
        ...
        DynamicBuffer_v1, ReadHandler>* this_handler)
  {
    return this_handler->start_ == 0 ? true
      : netio_handler_cont_helpers::is_continuation(
      ...
      read_until_delim_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          decay_t<ReadHandler>>(
            ...
            delim, handler2.value)(netio::error_code(), 0, 1);
    }
      ...
      read_until_expr_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          RegEx, decay_t<ReadHandler>>(
            stream_, static_cast<DynamicBuffer_v1&&>(buffers),
            expr, handler2.value)(netio::error_code(), 0, 1);
    }
      ...
      read_until_match_op_v1<AsyncReadStream,
        decay_t<DynamicBuffer_v1>,
          MatchCondition, decay_t<ReadHandler>>(
            stream_, static_cast<DynamicBuffer_v1&&>(buffers),
            match_condition, handler2.value)(netio::error_code(), 0, 1);
    }
...
#endif // NETIO_IMPL_READ_UNTIL_HPP
