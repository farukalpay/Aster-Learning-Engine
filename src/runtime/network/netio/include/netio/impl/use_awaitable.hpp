#ifndef NETIO_IMPL_USE_AWAITABLE_HPP
#define NETIO_IMPL_USE_AWAITABLE_HPP
...
public:
  ...
  {
    (void)u;
    NETIO_HANDLER_LOCATION((u.file_name_, u.line_, u.function_name_));
...
#endif // NETIO_IMPL_USE_AWAITABLE_HPP
