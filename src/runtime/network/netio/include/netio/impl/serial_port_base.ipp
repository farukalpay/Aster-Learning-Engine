#ifndef NETIO_IMPL_SERIAL_PORT_BASE_IPP
#define NETIO_IMPL_SERIAL_PORT_BASE_IPP
...
NETIO_SYNC_OP_VOID serial_port_base::baud_rate::store(
    NETIO_OPTION_STORAGE& storage, netio::error_code& ec) const
{
...
NETIO_SYNC_OP_VOID serial_port_base::baud_rate::load(
    const NETIO_OPTION_STORAGE& storage, netio::error_code& ec)
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::flow_control::store(
    NETIO_OPTION_STORAGE& storage, netio::error_code& ec) const
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::flow_control::load(
    const NETIO_OPTION_STORAGE& storage, netio::error_code& ec)
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::parity::store(
    NETIO_OPTION_STORAGE& storage, netio::error_code& ec) const
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
NETIO_SYNC_OP_VOID serial_port_base::parity::load(
    const NETIO_OPTION_STORAGE& storage, netio::error_code& ec)
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::stop_bits::store(
    NETIO_OPTION_STORAGE& storage, netio::error_code& ec) const
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
  switch (value_)
...
NETIO_SYNC_OP_VOID serial_port_base::stop_bits::load(
    const NETIO_OPTION_STORAGE& storage, netio::error_code& ec)
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::character_size::store(
    NETIO_OPTION_STORAGE& storage, netio::error_code& ec) const
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
NETIO_SYNC_OP_VOID serial_port_base::character_size::load(
    const NETIO_OPTION_STORAGE& storage, netio::error_code& ec)
{
#if defined(NETIO_WINDOWS) || defined(__CYGWIN__)
...
#endif // NETIO_IMPL_SERIAL_PORT_BASE_IPP
