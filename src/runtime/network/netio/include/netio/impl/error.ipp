#ifndef NETIO_IMPL_ERROR_IPP
#define NETIO_IMPL_ERROR_IPP
...
std::error_condition error_number_to_condition(int ev)
{
    ...
    case shut_down:
      return std::error_condition(ev, netio::system_category());
    case timed_out:
...
class netdb_category : public netio::error_category
{
public:
...
class addrinfo_category : public netio::error_category
{
public:
  const char* name() const noexcept
  {
    return "netio.addrinfo";
  }
...
class misc_category : public netio::error_category
{
public:
  const char* name() const noexcept
  {
