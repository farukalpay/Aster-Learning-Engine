#ifndef NETIO_IMPL_SYSTEM_CONTEXT_IPP
#define NETIO_IMPL_SYSTEM_CONTEXT_IPP
...
detail::scheduler& system_context::add_scheduler(detail::scheduler* s)
{
  ...
  netio::add_service<detail::scheduler>(*this, scoped_impl.get());
...
#endif // NETIO_IMPL_SYSTEM_CONTEXT_IPP
