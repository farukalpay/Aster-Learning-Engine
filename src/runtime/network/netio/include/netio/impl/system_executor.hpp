#ifndef NETIO_IMPL_SYSTEM_EXECUTOR_HPP
#define NETIO_IMPL_SYSTEM_EXECUTOR_HPP
...
#include "netio/detail/global.hpp"
    ...
    Function&& f, execution::blocking_t::never_t) const
{
  ...
  {
    NETIO_HANDLER_CREATION((ctx, *p.p,
...
#endif // NETIO_IMPL_SYSTEM_EXECUTOR_HPP
