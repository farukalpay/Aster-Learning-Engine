#ifndef NETIO_IMPL_EXECUTION_CONTEXT_IPP
#define NETIO_IMPL_EXECUTION_CONTEXT_IPP
...
void execution_context::notify_fork(
    netio::execution_context::fork_event event)
{
...
#endif // NETIO_IMPL_EXECUTION_CONTEXT_IPP
