#ifndef NETIO_IMPL_IO_CONTEXT_HPP
#define NETIO_IMPL_IO_CONTEXT_HPP
    ...
    Function&& f) const
{
  ...
  NETIO_HANDLER_CREATION((*context_ptr(), *p.p,
...
inline netio::io_context& io_context::service::get_io_context()
{
  return static_cast<netio::io_context&>(context());
}
...
#endif // NETIO_IMPL_IO_CONTEXT_HPP
