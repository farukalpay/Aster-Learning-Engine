#ifndef NETIO_IMPL_THREAD_POOL_HPP
#define NETIO_IMPL_THREAD_POOL_HPP
...
#include "netio/detail/blocking_executor_op.hpp"
...
thread_pool::thread_pool(allocator_arg_t, const Allocator& a)
  : execution_context(std::allocator_arg, a),
    scheduler_(netio::make_service<detail::scheduler>(*this, false)),
    ...
    Bits>::do_execute(Function&& f, false_type) const
{
  ...
  {
    NETIO_HANDLER_CREATION((*pool_, *p.p,
    ...
    Bits>::do_execute(Function&& f, true_type) const
{
  ...
  NETIO_HANDLER_CREATION((*pool_, op,
...
#endif // NETIO_IMPL_THREAD_POOL_HPP
