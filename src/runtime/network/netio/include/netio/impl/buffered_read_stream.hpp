#ifndef NETIO_IMPL_BUFFERED_READ_STREAM_HPP
#define NETIO_IMPL_BUFFERED_READ_STREAM_HPP
...
template <typename Stream>
std::size_t buffered_read_stream<Stream>::fill(netio::error_code& ec)
{
  detail::buffer_resize_guard<detail::buffered_stream_storage>
    resize_guard(storage_);
  std::size_t previous_size = storage_.size();
...
#endif // NETIO_IMPL_BUFFERED_READ_STREAM_HPP
