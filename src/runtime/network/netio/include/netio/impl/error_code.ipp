#ifndef NETIO_IMPL_ERROR_CODE_IPP
#define NETIO_IMPL_ERROR_CODE_IPP
...
# include <string>
#endif
#include "netio/detail/local_free_on_block_exit.hpp"
...
public:
  ...
  {
#if defined(NETIO_WINDOWS_RUNTIME) || defined(NETIO_WINDOWS_APP)
    ...
    if (length)
      ...
      return "netio.system error";
#else // defined(NETIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
#if !defined(__sun)
    if (value == ECANCELED)
...
#endif
#endif // defined(NETIO_WINDOWS_DESKTOP) || defined(__CYGWIN__)
  }
...
// For implementation of netio::error::detail::error_number_to_condition.
#include "netio/error.hpp"

#endif // NETIO_IMPL_ERROR_CODE_IPP
