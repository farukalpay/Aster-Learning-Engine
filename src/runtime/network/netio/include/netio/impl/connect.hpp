#ifndef NETIO_IMPL_CONNECT_HPP
#define NETIO_IMPL_CONNECT_HPP
...
namespace detail
{
  ...
  inline typename Protocol::endpoint deref_connect_result(
      Iterator iter, netio::error_code& ec)
  {
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      const netio::error_code& ec, Iterator next, Iterator end,
      constraint_t<
        is_same<
          result_of_t<ConnectCondition(netio::error_code, Iterator)>,
          Iterator
        >::value
      > = 0)
  {
  ...
  inline Iterator call_connect_condition(ConnectCondition& connect_condition,
      ...
      constraint_t<
        is_same<
          result_of_t<ConnectCondition(netio::error_code,
...
namespace detail
{
  ...
  protected:
    ...
    void check_condition(const netio::error_code& ec,
  ...
  protected:
    ...
    template <typename Iterator>
    void check_condition(const netio::error_code&, Iterator&, Iterator&)
    {
    }
  };
  ...
  public:
    ...
    void operator()(netio::error_code ec, int start = 0)
    {
  ...
  //private:
    template <typename Iterator>
    void process(netio::error_code ec,
        int start, Iterator begin, Iterator end)
    {
      ...
      switch (start_ = start)
      {
        ...
        for (;;)
        {
          ...
          {
            socket_.close(ec);
            NETIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_connect"));
  ...
  public:
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      // RangeConnectHandler.
      NETIO_RANGE_CONNECT_HANDLER_CHECK(RangeConnectHandler,
      ...
      range_connect_op<Protocol, Executor, EndpointSequence, ConnectCondition,
        decay_t<RangeConnectHandler>>(socket_, endpoints,
          connect_condition, handler2.value)(netio::error_code(), 1);
    }
  ...
  public:
        ...
        const ConnectCondition& connect_condition) const
    {
      ...
      NETIO_ITERATOR_CONNECT_HANDLER_CHECK(
