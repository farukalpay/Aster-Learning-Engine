#ifndef NETIO_IMPL_CANCEL_AFTER_HPP
#define NETIO_IMPL_CANCEL_AFTER_HPP
...
#include "netio/detail/timed_cancel_op.hpp"
...
struct initiate_cancel_after : initiation_base<Initiation>
{
      ...
      cancellation_type_t cancel_type, Args&&... args) &&
  {
    ...
    typename op::ptr p = { netio::detail::addressof(handler2.value),
...
#endif // NETIO_IMPL_CANCEL_AFTER_HPP
