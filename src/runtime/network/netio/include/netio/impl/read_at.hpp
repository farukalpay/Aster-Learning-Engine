#ifndef NETIO_IMPL_READ_AT_HPP
#define NETIO_IMPL_READ_AT_HPP
...
namespace detail
{
  ...
  {
    ec = netio::error_code();
    netio::detail::consuming_buffers<mutable_buffer,
    ...
    uint64_t offset, const MutableBufferSequence& buffers)
{
  ...
  netio::detail::throw_error(ec, "read_at");
...
namespace detail
{
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            NETIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_read_at"));
  ...
  //private:
    typedef netio::detail::consuming_buffers<mutable_buffer,
