#ifndef NETIO_IMPL_CONNECT_PIPE_IPP
#define NETIO_IMPL_CONNECT_PIPE_IPP
...
void create_pipe(native_pipe_handle p[2], netio::error_code& ec)
{
#if defined(NETIO_HAS_IOCP)
  ...
  _snwprintf(
      ...
      pipe_name, 128,
      // Include address of static to discriminate netio instances in DLLs.
      L"\\\\.\\pipe\\netio-A0812896-741A-484D-AF23-BE51BF620E22-%u-%p-%ld-%ld",
...
#endif // NETIO_IMPL_CONNECT_PIPE_IPP
