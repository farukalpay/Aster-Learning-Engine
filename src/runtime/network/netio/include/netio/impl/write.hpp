#ifndef NETIO_IMPL_WRITE_HPP
#define NETIO_IMPL_WRITE_HPP
    ...
    >)
{
  ...
  netio::detail::throw_error(ec, "write");
  ...
  public:
        ...
        std::size_t bytes_transferred, int start = 0)
    {
      ...
      switch (start_ = start)
      {
        ...
        {
          {
            NETIO_HANDLER_LOCATION((__FILE__, __LINE__, "async_write"));
