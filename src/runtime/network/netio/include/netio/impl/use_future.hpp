#ifndef NETIO_IMPL_USE_FUTURE_HPP
#define NETIO_IMPL_USE_FUTURE_HPP
...
public:
  ...
  {
    return netio::query(system_executor(), execution::context);
  }
  ...
  {
    netio::require(system_executor(), Blocking()).execute(
...
protected:
  ...
  {
    NETIO_REBIND_ALLOC(Allocator, char) b(a);
...
struct equality_comparable<
    netio::detail::promise_executor<T, Blocking>>
{
...
struct execute_member<
    netio::detail::promise_executor<T, Blocking>, Function>
{
  static constexpr bool is_valid = true;
  ...
  >
{
  static constexpr bool is_valid = true;
  static constexpr bool is_noexcept = true;
  typedef netio::detail::promise_executor<T,
...
#endif // NETIO_IMPL_USE_FUTURE_HPP
