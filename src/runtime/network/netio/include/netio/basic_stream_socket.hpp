#ifndef NETIO_BASIC_STREAM_SOCKET_HPP
#define NETIO_BASIC_STREAM_SOCKET_HPP
...
public:
   ...
   * @code
   * socket.send(netio::buffer(data, size));
   * @endcode
  ...
  std::size_t send(const ConstBufferSequence& buffers)
  {
    ...
    netio::detail::throw_error(ec, "send");
    return s;
  }
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.send(netio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_send(netio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.receive(netio::buffer(data, size));
   * @endcode
  ...
  std::size_t receive(const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().receive(
        this->impl_.get_implementation(), buffers, 0, ec);
    netio::detail::throw_error(ec, "receive");
    return s;
  }
   ...
   * follows:
   * @code
   * socket.receive(netio::buffer(data, size), 0);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(netio::buffer(data, size), 0, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.write_some(netio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_write_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * socket.read_some(netio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * socket.async_read_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // NETIO_BASIC_STREAM_SOCKET_HPP
