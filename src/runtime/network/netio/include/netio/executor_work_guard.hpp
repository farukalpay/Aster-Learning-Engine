#ifndef NETIO_EXECUTOR_WORK_GUARD_HPP
#define NETIO_EXECUTOR_WORK_GUARD_HPP
...
public:
  ...
  explicit executor_work_guard(const executor_type& e) noexcept
    : executor_(e),
      owns_(true)
  {
    new (&work_) work_type(netio::prefer(executor_,
 ...
 */
template <typename Executor>
NETIO_NODISCARD inline executor_work_guard<Executor>
...
NETIO_NODISCARD inline executor_work_guard<
...
#endif // NETIO_EXECUTOR_WORK_GUARD_HPP
