#ifndef NETIO_IP_NETWORK_V4_HPP
#define NETIO_IP_NETWORK_V4_HPP
...
/**
 * The netio::ip::network_v4 class provides the ability to use and
...
public:
  ...
  NETIO_DECL network_v4(const address_v4& addr,
  ...
  NETIO_DECL address_v4 netmask() const noexcept;
  ...
  NETIO_DECL address_v4_range hosts() const noexcept;
  ...
  NETIO_DECL bool is_subnet_of(const network_v4& other) const;

  /// Get the network as an address in dotted decimal format.
  NETIO_DECL std::string to_string() const;

  /// Get the network as an address in dotted decimal format.
  NETIO_DECL std::string to_string(netio::error_code& ec) const;
 ...
 * @relates network_v4
 */
NETIO_DECL network_v4 make_network_v4(const char* str);
 ...
 * @relates network_v4
 */
NETIO_DECL network_v4 make_network_v4(
    const char* str, netio::error_code& ec);
 ...
 * @relates network_v4
 */
NETIO_DECL network_v4 make_network_v4(const std::string& str);
 ...
 */
NETIO_DECL network_v4 make_network_v4(
    const std::string& str, netio::error_code& ec);
 ...
 * @relates network_v4
 */
NETIO_DECL network_v4 make_network_v4(string_view str);
 ...
 */
NETIO_DECL network_v4 make_network_v4(
    string_view str, netio::error_code& ec);
