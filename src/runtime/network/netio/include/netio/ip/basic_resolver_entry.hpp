#ifndef NETIO_IP_BASIC_RESOLVER_ENTRY_HPP
#define NETIO_IP_BASIC_RESOLVER_ENTRY_HPP
...
/**
 * The netio::ip::basic_resolver_entry class template describes an entry
...
#endif // NETIO_IP_BASIC_RESOLVER_ENTRY_HPP
