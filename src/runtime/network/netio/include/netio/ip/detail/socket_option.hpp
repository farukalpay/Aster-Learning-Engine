#ifndef NETIO_IP_DETAIL_SOCKET_OPTION_HPP
#define NETIO_IP_DETAIL_SOCKET_OPTION_HPP
...
{
public:
#if defined(NETIO_WINDOWS) && defined(UNDER_CE)
  typedef int ipv4_value_type;
#else
  typedef unsigned char ipv4_value_type;
#endif
...
private:
  netio::detail::in4_mreq_type ipv4_value_;
  netio::detail::in6_mreq_type ipv6_value_;
};
...
private:
  netio::detail::in4_addr_type ipv4_value_;
...
#endif // NETIO_IP_DETAIL_SOCKET_OPTION_HPP
