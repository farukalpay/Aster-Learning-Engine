#ifndef NETIO_IP_NETWORK_V6_HPP
#define NETIO_IP_NETWORK_V6_HPP
...
/**
 * The netio::ip::network_v6 class provides the ability to use and
...
public:
  ...
  NETIO_DECL network_v6(const address_v6& addr,
  ...
  NETIO_DECL address_v6 network() const noexcept;

  /// Obtain an address range corresponding to the hosts in the network.
  NETIO_DECL address_v6_range hosts() const noexcept;
  ...
  NETIO_DECL bool is_subnet_of(const network_v6& other) const;
 ...
 * @relates network_v6
 */
NETIO_DECL network_v6 make_network_v6(const char* str);
 ...
 * @relates network_v6
 */
NETIO_DECL network_v6 make_network_v6(
 ...
 * @relates network_v6
 */
NETIO_DECL network_v6 make_network_v6(const std::string& str);
 ...
 * @relates network_v6
 */
NETIO_DECL network_v6 make_network_v6(string_view str);
