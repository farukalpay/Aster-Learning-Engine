#ifndef NETIO_BIND_CANCELLATION_SLOT_HPP
#define NETIO_BIND_CANCELLATION_SLOT_HPP
...
template <typename CancellationSlot>
NETIO_NODISCARD inline partial_cancellation_slot_binder<CancellationSlot>
...
#endif // NETIO_BIND_CANCELLATION_SLOT_HPP
