#ifndef NETIO_CONFIG_HPP
#define NETIO_CONFIG_HPP
...
public:
  ...
  /// Constructor.
  NETIO_DECL explicit config_service(execution_context& ctx);

  /// Shutdown the service.
  NETIO_DECL void shutdown() override;

  /// Retrieve a configuration value.
  NETIO_DECL virtual const char* get_value(const char* section,
 ...
 *
 * @par Example
 * @code netio::io_context my_io_context{
 *     netio::config_from_concurrency_hint{1}}; @endcode
 */
class config_from_concurrency_hint : public execution_context::service_maker
{
public:
  /// Construct with a default concurrency hint.
  NETIO_DECL config_from_concurrency_hint();
  ...
  NETIO_DECL void make(execution_context& ctx) const override;
...
{
public:
  /// Construct with the default prefix "netio".
 ...
 * @par Example
 * @code netio::io_context my_io_context{
 *     netio::config_from_env{"my_app"}}; @endcode
 */
class config_from_env : public execution_context::service_maker
{
public:
  /// Construct with the default prefix "netio".
  NETIO_DECL config_from_env();
