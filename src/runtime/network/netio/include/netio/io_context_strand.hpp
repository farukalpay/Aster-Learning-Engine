#ifndef NETIO_IO_CONTEXT_STRAND_HPP
#define NETIO_IO_CONTEXT_STRAND_HPP
...
#include "netio/detail/strand_service.hpp"
...
public:
   ...
   */
  explicit strand(netio::io_context& io_context)
    : service_(netio::use_service<
        netio::detail::strand_service>(io_context))
  {
  ...
  netio::io_context& context() const noexcept
  {
   ...
   * @code netio::dispatch(strand, boost::bind(f, a1, ... an)); @endcode
   */
...
private:
  netio::detail::strand_service& service_;
  mutable netio::detail::strand_service::implementation_type impl_;
};
...
#endif // NETIO_IO_CONTEXT_STRAND_HPP
