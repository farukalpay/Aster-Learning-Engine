#ifndef NETIO_BUFFERED_WRITE_STREAM_HPP
#define NETIO_BUFFERED_WRITE_STREAM_HPP
...
public:
  ...
  /// error occurred.
  std::size_t flush(netio::error_code& ec);
...
#include "netio/impl/buffered_write_stream.hpp"

#endif // NETIO_BUFFERED_WRITE_STREAM_HPP
