#ifndef NETIO_CANCEL_AT_HPP
#define NETIO_CANCEL_AT_HPP
 ...
 */
template <typename Clock, typename WaitTraits = netio::wait_traits<Clock>>
...
NETIO_NODISCARD inline partial_cancel_at<Clock>
...
NETIO_NODISCARD inline partial_cancel_at_timer<Clock, WaitTraits, Executor>
...
NETIO_NODISCARD inline cancel_at_t<decay_t<CompletionToken>, Clock>
cancel_at(const chrono::time_point<Clock, Duration>& expiry,
...
#include "netio/impl/cancel_at.hpp"

#endif // NETIO_CANCEL_AT_HPP
