#ifndef NETIO_BASIC_DATAGRAM_SOCKET_HPP
#define NETIO_BASIC_DATAGRAM_SOCKET_HPP
...
public:
   ...
   *     netio::buffer(data, size), sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
...
#endif // NETIO_BASIC_DATAGRAM_SOCKET_HPP
