#ifndef NETIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP
#define NETIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP
...
struct default_immediate_executor
{
  ...
  static auto get(const E& e) noexcept
    -> decltype(netio::require(e, execution::blocking.never))
  {
    return netio::require(e, execution::blocking.never);
  }
};
...
{
  typedef void netio_associated_immediate_executor_is_unspecialised;
...
#endif // !defined(GENERATING_DOCUMENTATION)
{
  ...
  /// <tt>netio::require(ex, netio::execution::blocking.never)</tt>.
 ...
 */
template <typename T, typename Executor>
NETIO_NODISCARD inline auto get_associated_immediate_executor(
...
NETIO_NODISCARD inline typename associated_immediate_executor<T,
    ...
    enable_if_t<
      is_same<
        typename associated_immediate_executor<T,
          E>::netio_associated_immediate_executor_is_unspecialised,
        void
      >::value
    >>
{
...
#endif // NETIO_ASSOCIATED_IMMEDIATE_EXECUTOR_HPP
