#ifndef NETIO_WRITE_HPP
#define NETIO_WRITE_HPP
 ...
 * @code netio::write(s, netio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code netio::write(s, netio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code netio::write(s, netio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write netio::async_write
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * netio::async_write(s, netio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include "netio/impl/write.hpp"

#endif // NETIO_WRITE_HPP
