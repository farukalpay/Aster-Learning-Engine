#ifndef NETIO_DEFER_HPP
#define NETIO_DEFER_HPP
...
#include "netio/detail/initiate_defer.hpp"
 ...
 * @code void() @endcode
 */
template <NETIO_COMPLETION_TOKEN_FOR(void()) NullaryToken = deferred_t>
...
template <typename Executor,
    NETIO_COMPLETION_TOKEN_FOR(void()) NullaryToken
 ...
 * on the executor. For example, netio::io_context will allow the
 * exception to propagate to the caller that runs the @c io_context, whereas
 * netio::thread_pool will call @c std::terminate.
 *
 * @par Example
 ...
 *    // ...
 *
 *    int result = co_await netio::defer(
 *        []{
