#ifndef NETIO_TRAITS_REQUIRE_MEMBER_HPP
#define NETIO_TRAITS_REQUIRE_MEMBER_HPP
...
# define NETIO_HAS_DEDUCED_REQUIRE_MEMBER_TRAIT 1
...
#endif // NETIO_TRAITS_REQUIRE_MEMBER_HPP
