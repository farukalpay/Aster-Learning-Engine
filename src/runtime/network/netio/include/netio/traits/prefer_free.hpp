#ifndef NETIO_TRAITS_PREFER_FREE_HPP
#define NETIO_TRAITS_PREFER_FREE_HPP
...
# define NETIO_HAS_DEDUCED_PREFER_FREE_TRAIT 1
...
#else // defined(NETIO_HAS_DEDUCED_PREFER_FREE_TRAIT)
...
#endif // NETIO_TRAITS_PREFER_FREE_HPP
