#ifndef NETIO_COMPOSED_HPP
#define NETIO_COMPOSED_HPP
 ...
 *   -> decltype(
 *     netio::async_initiate<CompletionToken,
 ...
 *         token))
 * {
 *   return netio::async_initiate<CompletionToken,
 *     void(netio::error_code, std::size_t)>(
 *       netio::composed(
 *         async_echo_implementation{socket, buffer,
 *           async_echo_implementation::starting}, socket),
 *       token, netio::error_code{}, 0);
 * } @endcode
 */
