#ifndef NETIO_EXECUTION_MAPPING_HPP
#define NETIO_EXECUTION_MAPPING_HPP
...
struct mapping_t
{
  ...
  {
    return netio::query(ex, thread_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, new_thread_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, other_t());
  }

  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(thread_t, thread);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(new_thread_t, new_thread);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(other_t, other);
...
NETIO_INLINE_VARIABLE constexpr mapping_t mapping;
...
#endif // NETIO_EXECUTION_MAPPING_HPP
