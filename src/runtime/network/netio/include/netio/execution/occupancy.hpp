#ifndef NETIO_EXECUTION_OCCUPANCY_HPP
#define NETIO_EXECUTION_OCCUPANCY_HPP
...
NETIO_INLINE_VARIABLE constexpr occupancy_t occupancy;
...
#endif // NETIO_EXECUTION_OCCUPANCY_HPP
