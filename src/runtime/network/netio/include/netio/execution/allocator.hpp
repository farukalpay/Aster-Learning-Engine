#ifndef NETIO_EXECUTION_ALLOCATOR_HPP
#define NETIO_EXECUTION_ALLOCATOR_HPP
...
NETIO_INLINE_VARIABLE constexpr allocator_t<void> allocator;
...
#endif // NETIO_EXECUTION_ALLOCATOR_HPP
