#ifndef NETIO_EXECUTION_BLOCKING_HPP
#define NETIO_EXECUTION_BLOCKING_HPP
...
struct blocking_t
{
...
#else // defined(NETIO_HAS_DEDUCED_QUERY_STATIC_CONSTEXPR_MEMBER_TRAIT)
    typedef T type;
  ...
  {
    return netio::query(ex, possibly_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, always_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, never_t());
  }

  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(possibly_t, possibly);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(always_t, always);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(never_t, never);
...
public:
  ...
  {
    return netio::query(executor_, p);
  }
  ...
  {
    return netio::require(executor_, possibly_t<I>());
  }
  ...
  {
    return netio::require(executor_, never_t<I>());
  }
...
NETIO_INLINE_VARIABLE constexpr blocking_t blocking;
...
#if !defined(NETIO_HAS_DEDUCED_REQUIRE_FREE_TRAIT)
...
#endif // !defined(NETIO_HAS_DEDUCED_REQUIRE_FREE_TRAIT)
...
#endif // NETIO_EXECUTION_BLOCKING_HPP
