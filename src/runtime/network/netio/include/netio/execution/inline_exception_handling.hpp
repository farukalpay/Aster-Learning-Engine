#ifndef NETIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
#define NETIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
...
struct inline_exception_handling_t
{
  ...
  {
    return netio::query(ex, propagate_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, capture_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, terminate_t());
  }

  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(propagate_t, propagate);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(capture_t, capture);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(terminate_t, terminate);
...
NETIO_INLINE_VARIABLE constexpr
...
#endif // NETIO_EXECUTION_INLINE_EXCEPTION_HANDLING_HPP
