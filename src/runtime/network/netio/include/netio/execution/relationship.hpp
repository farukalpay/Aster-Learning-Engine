#ifndef NETIO_EXECUTION_RELATIONSHIP_HPP
#define NETIO_EXECUTION_RELATIONSHIP_HPP
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, continuation_t());
  }

  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(fork_t, fork);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(continuation_t, continuation);
...
NETIO_INLINE_VARIABLE constexpr relationship_t relationship;
...
#endif // NETIO_EXECUTION_RELATIONSHIP_HPP
