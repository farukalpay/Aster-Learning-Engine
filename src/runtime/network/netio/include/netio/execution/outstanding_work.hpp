#ifndef NETIO_EXECUTION_OUTSTANDING_WORK_HPP
#define NETIO_EXECUTION_OUTSTANDING_WORK_HPP
...
struct outstanding_work_t
{
  ...
  {
    return netio::query(ex, untracked_t());
  }
...
#endif // !defined(__clang__)
  {
    return netio::query(ex, tracked_t());
  }

  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(untracked_t, untracked);
  NETIO_STATIC_CONSTEXPR_DEFAULT_INIT(tracked_t, tracked);
...
NETIO_INLINE_VARIABLE constexpr outstanding_work_t outstanding_work;
...
#endif // NETIO_EXECUTION_OUTSTANDING_WORK_HPP
