#ifndef NETIO_EXECUTION_CONTEXT2_HPP
#define NETIO_EXECUTION_CONTEXT2_HPP
...
NETIO_INLINE_VARIABLE constexpr context_t context;
...
#endif // NETIO_EXECUTION_CONTEXT2_HPP
