#ifndef NETIO_GENERIC_RAW_PROTOCOL_HPP
#define NETIO_GENERIC_RAW_PROTOCOL_HPP
...
/**
 * The netio::generic::raw_protocol class contains flags necessary for
 ...
 * @code raw_protocol p(netio::ip::icmp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // NETIO_GENERIC_RAW_PROTOCOL_HPP
