#ifndef NETIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
#define NETIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
...
/**
 * The netio::generic::seq_packet_protocol class contains flags necessary
...
public:
  ...
  {
    return NETIO_OS_DEF(SOCK_SEQPACKET);
  }
...
#endif // NETIO_GENERIC_SEQ_PACKET_PROTOCOL_HPP
