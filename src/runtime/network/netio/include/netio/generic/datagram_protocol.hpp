#ifndef NETIO_GENERIC_DATAGRAM_PROTOCOL_HPP
#define NETIO_GENERIC_DATAGRAM_PROTOCOL_HPP
...
/**
 * The netio::generic::datagram_protocol class contains flags necessary
 ...
 * @code datagram_protocol p(netio::ip::udp::v4()); @endcode
 *
 * @par Thread Safety
...
#endif // NETIO_GENERIC_DATAGRAM_PROTOCOL_HPP
