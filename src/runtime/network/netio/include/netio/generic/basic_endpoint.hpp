#ifndef NETIO_GENERIC_BASIC_ENDPOINT_HPP
#define NETIO_GENERIC_BASIC_ENDPOINT_HPP
...
/**
 * The netio::generic::basic_endpoint class template describes an endpoint
...
private:
  ...
  netio::generic::detail::endpoint impl_;
};
...
#endif // NETIO_GENERIC_BASIC_ENDPOINT_HPP
