#ifndef NETIO_BASIC_RANDOM_ACCESS_FILE_HPP
#define NETIO_BASIC_RANDOM_ACCESS_FILE_HPP
...
#if !defined(NETIO_BASIC_RANDOM_ACCESS_FILE_FWD_DECL)
#define NETIO_BASIC_RANDOM_ACCESS_FILE_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Executor = any_io_executor>
class basic_random_access_file;

#endif // !defined(NETIO_BASIC_RANDOM_ACCESS_FILE_FWD_DECL)
...
public:
   ...
   * @code
   * handle.write_some_at(42, netio::buffer(data, size));
   * @endcode
      ...
      const ConstBufferSequence& buffers)
  {
    ...
    netio::detail::throw_error(ec, "write_some_at");
    return s;
  }
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_write_some_at(42, netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * handle.read_some_at(42, netio::buffer(data, size));
   * @endcode
      ...
      const MutableBufferSequence& buffers)
  {
    ...
    std::size_t s = this->impl_.get_service().read_some_at(
        this->impl_.get_implementation(), offset, buffers, ec);
    netio::detail::throw_error(ec, "read_some_at");
    return s;
  }
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * handle.async_read_some_at(42, netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // NETIO_BASIC_RANDOM_ACCESS_FILE_HPP
