#ifndef NETIO_COMPLETION_CONDITION_HPP
#define NETIO_COMPLETION_CONDITION_HPP
...
struct is_completion_condition_helper<T,
    enable_if_t<
      is_same<
        result_of_t<T(netio::error_code, std::size_t)>,
        bool
      >::value
    >
  > : true_type
 ...
 * netio::error_code ec;
 * std::size_t n = netio::read(
 *     sock, netio::buffer(buf),
 *     netio::transfer_all(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
...
#endif // NETIO_COMPLETION_CONDITION_HPP
