#ifndef NETIO_CANCELLATION_SIGNAL_HPP
#define NETIO_CANCELLATION_SIGNAL_HPP
...
public:
  ...
  NETIO_DECL ~cancellation_signal();
...
public:
   ...
   * @code void handler(netio::cancellation_type_t); @endcode
   *
...
private:
  ...
  NETIO_DECL std::pair<void*, std::size_t> prepare_memory(
...
#endif // NETIO_CANCELLATION_SIGNAL_HPP
