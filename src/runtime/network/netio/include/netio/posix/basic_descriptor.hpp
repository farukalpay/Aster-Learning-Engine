#ifndef NETIO_POSIX_BASIC_DESCRIPTOR_HPP
#define NETIO_POSIX_BASIC_DESCRIPTOR_HPP
...
# include "netio/detail/reactive_descriptor_service.hpp"
...
public:
   ...
   */
  NETIO_SYNC_OP_VOID assign(const native_handle_type& native_descriptor,
      netio::error_code& ec)
  {
   ...
   * netio::error::operation_aborted error.
   *
   ...
   * passed the netio::error::operation_aborted error.
   *
   * @throws netio::system_error Thrown on failure.
   */
  void cancel()
   ...
   * netio::posix::descriptor_base::bytes_readable @n
   * netio::posix::descriptor_base::non_blocking_io
   *
   * @par Example
   * Getting the number of bytes ready to read:
   * @code
   * netio::posix::stream_descriptor descriptor(my_context);
   * ...
   * netio::posix::stream_descriptor::bytes_readable command;
   ...
   * netio::posix::stream_descriptor descriptor(my_context);
   * ...
   * descriptor.wait(netio::posix::stream_descriptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * netio::error_code ec;
   * descriptor.wait(netio::posix::stream_descriptor::wait_read, ec);
   * @endcode
   */
   ...
   *     netio::posix::stream_descriptor::wait_read,
   *     wait_handler);
   * @endcode
   *
   * @par Per-Operation Cancellation
   * This asynchronous operation supports cancellation for the following
   * netio::cancellation_type values:
   *
...
#endif // NETIO_POSIX_BASIC_DESCRIPTOR_HPP
