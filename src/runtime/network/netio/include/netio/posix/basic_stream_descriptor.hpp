#ifndef NETIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
#define NETIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
...
public:
   ...
   * @code
   * descriptor.write_some(netio::buffer(data, size));
   * @endcode
   ...
   * To write a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_write_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on writing multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * @code
   * descriptor.read_some(netio::buffer(data, size));
   * @endcode
   ...
   * To read into a single data buffer use the @ref buffer function as follows:
   * @code
   * descriptor.async_read_some(netio::buffer(data, size), handler);
   * @endcode
   * See the @ref buffer documentation for information on reading into multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // NETIO_POSIX_BASIC_STREAM_DESCRIPTOR_HPP
