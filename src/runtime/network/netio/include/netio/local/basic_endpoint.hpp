#ifndef NETIO_LOCAL_BASIC_ENDPOINT_HPP
#define NETIO_LOCAL_BASIC_ENDPOINT_HPP
...
#include "netio/local/detail/endpoint.hpp"
...
/**
 * The netio::local::basic_endpoint class template describes an endpoint
...
private:
  ...
  netio::local::detail::endpoint impl_;
};
 ...
 *
 * @relates netio::local::basic_endpoint
 */
...
#endif // NETIO_LOCAL_BASIC_ENDPOINT_HPP
