#ifndef NETIO_LOCAL_SEQ_PACKET_PROTOCOL_HPP
#define NETIO_LOCAL_SEQ_PACKET_PROTOCOL_HPP
...
/**
 * The netio::local::seq_packet_protocol class contains flags necessary
...
#endif // NETIO_LOCAL_SEQ_PACKET_PROTOCOL_HPP
