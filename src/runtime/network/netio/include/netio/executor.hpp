#ifndef NETIO_EXECUTOR_HPP
#define NETIO_EXECUTOR_HPP
...
public:
   ...
   */
#if !defined(NETIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
  const std::type_info& target_type() const noexcept
  {
    return impl_ ? impl_->target_type() : typeid(void);
  }
#else // !defined(NETIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
  const void* target_type() const noexcept
  {
    return impl_ ? impl_->target_type() : 0;
  }
#endif // !defined(NETIO_NO_TYPEID) || defined(GENERATING_DOCUMENTATION)
...
NETIO_USES_ALLOCATOR(netio::executor)

#include "netio/detail/pop_options.hpp"

#include "netio/impl/executor.hpp"
