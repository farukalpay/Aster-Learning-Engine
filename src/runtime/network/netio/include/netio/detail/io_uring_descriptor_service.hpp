#ifndef NETIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP
#define NETIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP
...
#include "netio/detail/io_uring_descriptor_read_at_op.hpp"
#include "netio/detail/io_uring_descriptor_read_op.hpp"
#include "netio/detail/io_uring_descriptor_write_at_op.hpp"
#include "netio/detail/io_uring_descriptor_write_op.hpp"
#include "netio/detail/io_uring_null_buffers_op.hpp"
#include "netio/detail/io_uring_service.hpp"
#include "netio/detail/io_uring_wait_op.hpp"
...
public:
  ...
  // Constructor.
  NETIO_DECL io_uring_descriptor_service(execution_context& context);
      ...
      const null_buffers&, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    NETIO_HANDLER_CREATION((io_uring_service_.context(),
...
private:
  ...
  NETIO_DECL void start_op(implementation_type& impl, int op_type,
...
#endif // NETIO_DETAIL_IO_URING_DESCRIPTOR_SERVICE_HPP
