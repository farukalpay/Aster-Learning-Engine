#ifndef NETIO_DETAIL_INITIATE_DISPATCH_HPP
#define NETIO_DETAIL_INITIATE_DISPATCH_HPP
...
public:
      ...
      >* = 0) const
  {
    ...
    netio::prefer(ex, execution::allocator(alloc)).execute(
      ...
      >* = 0) const
  {
    ...
    ex.dispatch(netio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    netio::prefer(ex_, execution::allocator(alloc)).execute(
        netio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)));
  }
      ...
      >* = 0) const
  {
    ...
    ex_.dispatch(netio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
...
#endif // NETIO_DETAIL_INITIATE_DISPATCH_HPP
