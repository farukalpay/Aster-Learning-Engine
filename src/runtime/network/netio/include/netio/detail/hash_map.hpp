#ifndef NETIO_DETAIL_HASH_MAP_HPP
#define NETIO_DETAIL_HASH_MAP_HPP
...
public:
  ...
  {
    NETIO_ASSERT(it != values_.end());
    NETIO_ASSERT(num_buckets_ != 0);
...
private:
  ...
  static std::size_t hash_size(std::size_t num_elems)
  {
    ...
    {
#if defined(NETIO_HASH_MAP_BUCKETS)
      NETIO_HASH_MAP_BUCKETS
#else // NETIO_HASH_MAP_BUCKETS
      3, 13, 23, 53, 97, 193, 389, 769, 1543, 3079, 6151, 12289, 24593,
      49157, 98317, 196613, 393241, 786433, 1572869, 3145739, 6291469,
      12582917, 25165843
#endif // NETIO_HASH_MAP_BUCKETS
    };
...
#endif // NETIO_DETAIL_HASH_MAP_HPP
