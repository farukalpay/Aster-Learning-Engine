#ifndef NETIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
#define NETIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(win_iocp_handle_read_op);
...
#endif // NETIO_DETAIL_WIN_IOCP_HANDLE_READ_OP_HPP
