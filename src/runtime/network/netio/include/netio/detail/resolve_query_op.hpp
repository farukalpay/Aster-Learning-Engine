#ifndef NETIO_DETAIL_RESOLVE_QUERY_OP_HPP
#define NETIO_DETAIL_RESOLVE_QUERY_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(resolve_query_op);
...
private:
  ...
  netio::detail::addrinfo_type* addrinfo_;
};
...
#endif // NETIO_DETAIL_RESOLVE_QUERY_OP_HPP
