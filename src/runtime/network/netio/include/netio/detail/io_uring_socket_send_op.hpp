#ifndef NETIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
...
{
public:
  io_uring_socket_send_op_base(const netio::error_code& success_ec,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_send_op);

  io_uring_socket_send_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_SEND_OP_HPP
