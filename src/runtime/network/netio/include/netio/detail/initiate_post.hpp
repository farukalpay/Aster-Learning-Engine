#ifndef NETIO_DETAIL_INITIATE_POST_HPP
#define NETIO_DETAIL_INITIATE_POST_HPP
...
public:
      ...
      >* = 0) const
  {
    ...
    ex.post(netio::detail::bind_handler(
...
public:
      ...
      >* = 0) const
  {
    ...
    ex_.post(netio::detail::bind_handler(
          static_cast<CompletionHandler&&>(handler)), alloc);
  }
...
#endif // NETIO_DETAIL_INITIATE_POST_HPP
