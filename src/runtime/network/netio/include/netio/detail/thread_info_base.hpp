#ifndef NETIO_DETAIL_THREAD_INFO_BASE_HPP
#define NETIO_DETAIL_THREAD_INFO_BASE_HPP
...
#ifndef NETIO_RECYCLING_ALLOCATOR_CACHE_SIZE
# define NETIO_RECYCLING_ALLOCATOR_CACHE_SIZE 2
#endif // NETIO_RECYCLING_ALLOCATOR_CACHE_SIZE
...
public:
  struct default_tag
  {
    enum
    {
      cache_size = NETIO_RECYCLING_ALLOCATOR_CACHE_SIZE,
      begin_mem_index = 0,
  ...
  static void* allocate(thread_info_base* this_thread,
      std::size_t size, std::size_t align = NETIO_DEFAULT_ALIGN)
  {
...
private:
  ...
  enum { chunk_size = 8 };
#else // defined(NETIO_HAS_IO_URING)
  enum { chunk_size = 4 };
...
#endif // NETIO_DETAIL_THREAD_INFO_BASE_HPP
