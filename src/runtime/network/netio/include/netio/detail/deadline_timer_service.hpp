#ifndef NETIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
#define NETIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
...
#include "netio/detail/timer_queue.hpp"
#include "netio/detail/timer_scheduler.hpp"
...
public:
  ...
  deadline_timer_service(execution_context& context)
    : execution_context_service_base<
      ...
      scheduler_(netio::use_service<timer_scheduler>(context))
  {
  ...
  std::size_t cancel(implementation_type& impl, netio::error_code& ec)
  {
    if (!impl.might_have_pending_waits)
    {
      ec = netio::error_code();
  ...
  std::size_t expires_at(implementation_type& impl,
      const time_type& expiry_time, netio::error_code& ec)
  {
  ...
  std::size_t expires_after(implementation_type& impl,
      const duration_type& expiry_time, netio::error_code& ec)
  {
  ...
  void wait(implementation_type& impl, netio::error_code& ec)
  {
...
private:
  ...
  void do_wait(const Duration& timeout, netio::error_code& ec)
  {
#if defined(NETIO_WINDOWS_RUNTIME)
...
#endif // NETIO_DETAIL_DEADLINE_TIMER_SERVICE_HPP
