#ifndef NETIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
#define NETIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
...
public:
  ...
  void set(reactor_op_queue<socket_type>& operations, op_queue<operation>& ops)
  {
    ...
    while (i != operations.end())
    {
      ...
      {
        netio::error_code ec(error::fd_set_failure);
...
#endif // NETIO_DETAIL_POSIX_FD_SET_ADAPTER_HPP
