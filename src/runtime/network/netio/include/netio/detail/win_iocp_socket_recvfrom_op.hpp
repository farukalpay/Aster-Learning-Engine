#ifndef NETIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
#define NETIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(win_iocp_socket_recvfrom_op);
...
#endif // NETIO_DETAIL_WIN_IOCP_SOCKET_RECVFROM_OP_HPP
