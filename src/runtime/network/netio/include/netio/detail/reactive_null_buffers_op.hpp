#ifndef NETIO_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
#define NETIO_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_null_buffers_op);

  reactive_null_buffers_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_REACTIVE_NULL_BUFFERS_OP_HPP
