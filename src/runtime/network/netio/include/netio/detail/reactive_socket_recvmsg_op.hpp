#ifndef NETIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP
#define NETIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP
...
{
public:
  reactive_socket_recvmsg_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recvmsg",
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_recvmsg_op);

  reactive_socket_recvmsg_op(const netio::error_code& success_ec,
      socket_type socket, const MutableBufferSequence& buffers,
      socket_base::message_flags in_flags,
...
#endif // NETIO_DETAIL_REACTIVE_SOCKET_RECVMSG_OP_HPP
