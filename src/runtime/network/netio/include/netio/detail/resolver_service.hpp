#ifndef NETIO_DETAIL_RESOLVER_SERVICE_HPP
#define NETIO_DETAIL_RESOLVER_SERVICE_HPP
...
#include "netio/detail/resolve_endpoint_op.hpp"
#include "netio/detail/resolve_query_op.hpp"
...
public:
  ...
  results_type resolve(implementation_type&, const query_type& qry,
      netio::error_code& ec)
  {
    netio::detail::addrinfo_type* address_info = 0;
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    NETIO_HANDLER_CREATION((thread_pool_.context(),
...
#endif // NETIO_DETAIL_RESOLVER_SERVICE_HPP
