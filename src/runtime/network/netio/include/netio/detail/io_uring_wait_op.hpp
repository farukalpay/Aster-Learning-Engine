#ifndef NETIO_DETAIL_IO_URING_WAIT_OP_HPP
#define NETIO_DETAIL_IO_URING_WAIT_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_wait_op);

  io_uring_wait_op(const netio::error_code& success_ec, int descriptor,
...
#endif // NETIO_DETAIL_IO_URING_WAIT_OP_HPP
