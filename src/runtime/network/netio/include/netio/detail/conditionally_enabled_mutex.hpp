#ifndef NETIO_DETAIL_CONDITIONALLY_ENABLED_MUTEX_HPP
#define NETIO_DETAIL_CONDITIONALLY_ENABLED_MUTEX_HPP
...
#endif // NETIO_DETAIL_CONDITIONALLY_ENABLED_MUTEX_HPP
