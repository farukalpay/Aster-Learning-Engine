#ifndef NETIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
#define NETIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
...
{
public:
  reactive_socket_recvfrom_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_recvfrom",
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_recvfrom_op);

  reactive_socket_recvfrom_op(const netio::error_code& success_ec,
      socket_type socket, int protocol_type,
      const MutableBufferSequence& buffers, Endpoint& endpoint,
...
#endif // NETIO_DETAIL_REACTIVE_SOCKET_RECVFROM_OP_HPP
