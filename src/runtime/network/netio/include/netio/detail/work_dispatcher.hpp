#ifndef NETIO_DETAIL_WORK_DISPATCHER_HPP
#define NETIO_DETAIL_WORK_DISPATCHER_HPP
...
public:
  ...
  auto bind_result(Handler&& handler)
    -> decltype(
      netio::detail::move_bind_handler(
        static_cast<Handler&&>(handler),
        static_cast<Function&&>(function_)()))
  {
    return netio::detail::move_bind_handler(
        static_cast<Handler&&>(handler),
        static_cast<Function&&>(function_)());
  }
};
...
public:
  ...
  template <typename Handler>
  auto bind_result(Handler&& handler)
    -> decltype(netio::detail::bind_handler(
      static_cast<Handler&&>(handler)))
  {
    static_cast<Function&&>(function_)();
    return netio::detail::bind_handler(
        static_cast<Handler&&>(handler));
  }
};
...
public:
  ...
  work_dispatcher(F&& function, CompletionHandler&& handler,
    ...
    : work_dispatcher_function<Function>(static_cast<F&&>(function)),
      ...
      executor_(netio::prefer(handler_ex,
  ...
  void operator()()
  {
    ...
    netio::prefer(executor_, execution::allocator(alloc)).execute(
...
#endif // NETIO_DETAIL_WORK_DISPATCHER_HPP
