#ifndef NETIO_DETAIL_IS_BUFFER_SEQUENCE_HPP
#define NETIO_DETAIL_IS_BUFFER_SEQUENCE_HPP
...
char (&buffer_sequence_begin_helper(T* t,
    enable_if_t<!is_same<
      decltype(netio::buffer_sequence_begin(*t)),
        void>::value>*))[2];
...
char (&buffer_sequence_end_helper(T* t,
    enable_if_t<!is_same<
      decltype(netio::buffer_sequence_end(*t)),
        void>::value>*))[2];
...
#endif // NETIO_DETAIL_IS_BUFFER_SEQUENCE_HPP
