#ifndef NETIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
#define NETIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
...
{
public:
  reactive_socket_send_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_send",
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_send_op);

  reactive_socket_send_op(const netio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state,
...
#endif // NETIO_DETAIL_REACTIVE_SOCKET_SEND_OP_HPP
