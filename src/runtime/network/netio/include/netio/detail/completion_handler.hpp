#ifndef NETIO_DETAIL_COMPLETION_HANDLER_HPP
#define NETIO_DETAIL_COMPLETION_HANDLER_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(completion_handler);
...
#endif // NETIO_DETAIL_COMPLETION_HANDLER_HPP
