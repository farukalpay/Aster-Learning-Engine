#ifndef NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_AT_OP_HPP
#define NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_AT_OP_HPP
...
public:
  io_uring_descriptor_write_at_op_base(
      const netio::error_code& success_ec, int descriptor,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_descriptor_write_at_op);

  io_uring_descriptor_write_at_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_AT_OP_HPP
