#ifndef NETIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
#define NETIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(win_iocp_handle_write_op);
  ...
  static void do_complete(void* owner, operation* base,
      const netio::error_code& result_ec, std::size_t bytes_transferred)
  {
...
#endif // NETIO_DETAIL_WIN_IOCP_HANDLE_WRITE_OP_HPP
