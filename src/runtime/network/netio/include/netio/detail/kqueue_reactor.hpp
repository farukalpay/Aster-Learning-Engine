#ifndef NETIO_DETAIL_KQUEUE_REACTOR_HPP
#define NETIO_DETAIL_KQUEUE_REACTOR_HPP
...
public:
  ...
  // Constructor.
  NETIO_DECL kqueue_reactor(netio::execution_context& ctx);

  // Destructor.
  NETIO_DECL ~kqueue_reactor();
...
private:
  ...
  // cannot be created.
  NETIO_DECL static int do_kqueue_create();
  ...
  NETIO_DECL timespec* get_timeout(long usec, timespec& ts);
...
#include "netio/detail/impl/kqueue_reactor.hpp"
...
#endif // NETIO_DETAIL_KQUEUE_REACTOR_HPP
