#ifndef NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
#define NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
...
{
public:
  io_uring_descriptor_write_op_base(const netio::error_code& success_ec,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_descriptor_write_op);

  io_uring_descriptor_write_op(const netio::error_code& success_ec,
      int descriptor, descriptor_ops::state_type state,
...
#endif // NETIO_DETAIL_IO_URING_DESCRIPTOR_WRITE_OP_HPP
