#ifndef NETIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP
...
#include "netio/detail/io_uring_null_buffers_op.hpp"
#include "netio/detail/io_uring_service.hpp"
#include "netio/detail/io_uring_socket_accept_op.hpp"
#include "netio/detail/io_uring_socket_connect_op.hpp"
#include "netio/detail/io_uring_socket_recvfrom_op.hpp"
#include "netio/detail/io_uring_socket_sendto_op.hpp"
#include "netio/detail/io_uring_socket_service_base.hpp"
...
public:
  ...
  netio::error_code bind(implementation_type& impl,
      const endpoint_type& endpoint, netio::error_code& ec)
  {
  ...
  netio::error_code shutdown(base_implementation_type& impl,
      socket_base::shutdown_type what, netio::error_code& ec)
  {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    NETIO_HANDLER_CREATION((io_uring_service_.context(), *p.p,
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    NETIO_HANDLER_CREATION((io_uring_service_.context(), *p.p, "socket",
  ...
  netio::error_code accept(implementation_type& impl,
      Socket& peer, endpoint_type* peer_endpoint, netio::error_code& ec)
  {
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_SERVICE_HPP
