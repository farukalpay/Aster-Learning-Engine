#ifndef NETIO_DETAIL_WRAPPED_HANDLER_HPP
#define NETIO_DETAIL_WRAPPED_HANDLER_HPP
...
struct is_continuation_delegated
{
  ...
  {
    return netio_handler_cont_helpers::is_continuation(handler);
  }
};
...
#endif // NETIO_DETAIL_WRAPPED_HANDLER_HPP
