#ifndef NETIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP
...
{
public:
  io_uring_socket_recvfrom_op_base(const netio::error_code& success_ec,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_recvfrom_op);

  io_uring_socket_recvfrom_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_RECVFROM_OP_HPP
