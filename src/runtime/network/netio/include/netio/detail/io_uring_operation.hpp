#ifndef NETIO_DETAIL_IO_URING_OPERATION_HPP
#define NETIO_DETAIL_IO_URING_OPERATION_HPP
...
protected:
  ...
  io_uring_operation(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_OPERATION_HPP
