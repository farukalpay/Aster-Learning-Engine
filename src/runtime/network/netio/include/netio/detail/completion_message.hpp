#ifndef NETIO_DETAIL_COMPLETION_MESSAGE_HPP
#define NETIO_DETAIL_COMPLETION_MESSAGE_HPP
...
public:
  ...
  {
    this->do_receive(h, netio::detail::index_sequence_for<Args...>());
  }

private:
  template <typename Handler, std::size_t... I>
  void do_receive(Handler& h, netio::detail::index_sequence<I...>)
  {
...
#endif // NETIO_DETAIL_COMPLETION_MESSAGE_HPP
