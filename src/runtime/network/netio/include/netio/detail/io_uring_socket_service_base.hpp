#ifndef NETIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP
...
#include "netio/detail/io_uring_socket_recv_op.hpp"
#include "netio/detail/io_uring_socket_recvmsg_op.hpp"
#include "netio/detail/io_uring_socket_send_op.hpp"
...
public:
  ...
  // Constructor.
  NETIO_DECL io_uring_socket_service_base(execution_context& context);
...
protected:
  ...
  NETIO_DECL void start_op(base_implementation_type& impl, int op_type,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_SERVICE_BASE_HPP
