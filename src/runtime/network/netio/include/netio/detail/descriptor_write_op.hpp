#ifndef NETIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
#define NETIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
...
{
public:
  descriptor_write_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_write",
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(descriptor_write_op);

  descriptor_write_op(const netio::error_code& success_ec,
      int descriptor, const ConstBufferSequence& buffers,
...
#endif // NETIO_DETAIL_DESCRIPTOR_WRITE_OP_HPP
