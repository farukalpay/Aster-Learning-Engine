#ifndef NETIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
#define NETIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_descriptor_read_at_op);

  io_uring_descriptor_read_at_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_DESCRIPTOR_READ_AT_OP_HPP
