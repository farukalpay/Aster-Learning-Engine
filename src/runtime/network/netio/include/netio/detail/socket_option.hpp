#ifndef NETIO_DETAIL_SOCKET_OPTION_HPP
#define NETIO_DETAIL_SOCKET_OPTION_HPP
...
public:
  ...
  {
    enabled(e);
    timeout NETIO_PREVENT_MACRO_SUBSTITUTION(t);
  }
  ...
  void timeout NETIO_PREVENT_MACRO_SUBSTITUTION(int value)
  {
#if defined(WIN32)
  ...
  int timeout NETIO_PREVENT_MACRO_SUBSTITUTION() const
  {
...
#endif // NETIO_DETAIL_SOCKET_OPTION_HPP
