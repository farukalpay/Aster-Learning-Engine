#ifndef NETIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP
#define NETIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_null_buffers_op);

  io_uring_null_buffers_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_NULL_BUFFERS_OP_HPP
