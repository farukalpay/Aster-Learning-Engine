#ifndef NETIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
#define NETIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(resolve_endpoint_op);
...
#endif // NETIO_DETAIL_RESOLVER_ENDPOINT_OP_HPP
