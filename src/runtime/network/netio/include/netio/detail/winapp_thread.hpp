#ifndef NETIO_DETAIL_WINAPP_THREAD_HPP
#define NETIO_DETAIL_WINAPP_THREAD_HPP
...
#endif // defined(NETIO_WINDOWS) && defined(UNDER_CE)

#endif // NETIO_DETAIL_WINAPP_THREAD_HPP
