#ifndef NETIO_DETAIL_IO_URING_SOCKET_RECV_OP_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_RECV_OP_HPP
...
{
public:
  io_uring_socket_recv_op_base(const netio::error_code& success_ec,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_recv_op);

  io_uring_socket_recv_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_RECV_OP_HPP
