#ifndef NETIO_DETAIL_NULL_SOCKET_SERVICE_HPP
#define NETIO_DETAIL_NULL_SOCKET_SERVICE_HPP
...
public:
  ...
  netio::error_code open(implementation_type&,
      const protocol_type&, netio::error_code& ec)
  {
  ...
  netio::error_code assign(implementation_type&, const protocol_type&,
      const native_handle_type&, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  }
  ...
  // Destroy a socket implementation.
  netio::error_code close(implementation_type&,
      netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  ...
  netio::error_code cancel(implementation_type&,
      netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  ...
  netio::error_code listen(implementation_type&,
      int, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  }
  ...
  netio::error_code io_control(implementation_type&,
  ...
  netio::error_code non_blocking(implementation_type&,
  ...
  netio::error_code native_non_blocking(implementation_type&,
      bool, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  ...
  netio::error_code set_option(implementation_type&,
      const Option&, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  }
  ...
  // Set a socket option.
  template <typename Option>
  netio::error_code get_option(const implementation_type&,
      Option&, netio::error_code& ec) const
  {
    ec = netio::error::operation_not_supported;
    return ec;
  }
      ...
      socket_base::message_flags, Handler& handler, const IoExecutor& io_ex)
  {
    ...
    netio::post(io_ex, detail::bind_handler(
  ...
  netio::error_code accept(implementation_type&,
      Socket&, endpoint_type*, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
  }
  ...
  {
    netio::error_code ec = netio::error::operation_not_supported;
    netio::post(io_ex, detail::bind_handler(handler, ec));
  }

  // Connect the socket to the specified endpoint.
  netio::error_code connect(implementation_type&,
      const endpoint_type&, netio::error_code& ec)
  {
    ec = netio::error::operation_not_supported;
    return ec;
...
#endif // NETIO_DETAIL_NULL_SOCKET_SERVICE_HPP
