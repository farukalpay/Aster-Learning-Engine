#ifndef NETIO_DETAIL_REACTIVE_WAIT_OP_HPP
#define NETIO_DETAIL_REACTIVE_WAIT_OP_HPP
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_wait_op);

  reactive_wait_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_REACTIVE_WAIT_OP_HPP
