#ifndef NETIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
#define NETIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
...
#include "netio/detail/winrt_resolve_op.hpp"
...
public:
  ...
  results_type resolve(implementation_type&,
      const query_type& query, netio::error_code& ec)
  {
    try
    {
      ...
      Handler& handler, const IoExecutor& io_ex)
  {
    ...
    netio::post(io_ex, detail::bind_handler(handler, ec, results));
  }
...
#endif // NETIO_DETAIL_WINRT_RESOLVER_SERVICE_HPP
