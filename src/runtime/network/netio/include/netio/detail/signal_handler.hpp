#ifndef NETIO_DETAIL_SIGNAL_HANDLER_HPP
#define NETIO_DETAIL_SIGNAL_HANDLER_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(signal_handler);
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::binder2<Handler, netio::error_code, int>
...
#endif // NETIO_DETAIL_SIGNAL_HANDLER_HPP
