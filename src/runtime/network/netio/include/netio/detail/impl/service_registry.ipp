#ifndef NETIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
#define NETIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
    ...
    execution_context::service* new_service)
{
  if (&owner_ != &new_service->context())
    netio::detail::throw_exception(invalid_service_owner());
  ...
  {
    if (keys_match(service->key_, key))
      netio::detail::throw_exception(service_already_exists());
    service = service->next_;
  }
...
#endif // NETIO_DETAIL_IMPL_SERVICE_REGISTRY_IPP
