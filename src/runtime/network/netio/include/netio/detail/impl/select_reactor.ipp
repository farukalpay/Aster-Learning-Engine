#ifndef NETIO_DETAIL_IMPL_SELECT_REACTOR_IPP
#define NETIO_DETAIL_IMPL_SELECT_REACTOR_IPP
...
#include "netio/detail/fd_set_adapter.hpp"
...
select_reactor::select_reactor(netio::execution_context& ctx)
...
{
#if defined(NETIO_HAS_IOCP)
  netio::detail::signal_blocker sb;
    ...
    const netio::error_code& /*ec*/, std::size_t /*bytes_transferred*/)
{
  if (owner)
  {
    ...
    netio::detail::mutex::scoped_lock lock(reactor->mutex_);
...
#endif // NETIO_DETAIL_IMPL_SELECT_REACTOR_IPP
