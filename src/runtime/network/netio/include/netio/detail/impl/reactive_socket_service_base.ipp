#ifndef NETIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
#define NETIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
    ...
    reactive_socket_service_base::base_implementation_type& impl)
{
  ...
  {
    NETIO_HANDLER_OPERATION((reactor_.context(),
...
netio::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
    netio::error_code& ec)
{
  if (is_open(impl))
...
netio::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    netio::error_code& ec)
{
  if (!is_open(impl))
...
netio::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, netio::error_code& ec)
{
  if (is_open(impl))
  {
...
netio::error_code reactive_socket_service_base::do_assign(
    ...
    const void* immediate_arg)
{
  ...
  {
    op->ec_ = netio::error::already_open;
    on_immediate(op, is_continuation, immediate_arg);
  }
}
...
#endif // NETIO_DETAIL_IMPL_REACTIVE_SOCKET_SERVICE_BASE_IPP
