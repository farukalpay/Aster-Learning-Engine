#ifndef NETIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP
#define NETIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP
...
netio::error_code io_uring_socket_service_base::close(
    io_uring_socket_service_base::base_implementation_type& impl,
    netio::error_code& ec)
{
  if (is_open(impl))
...
netio::error_code io_uring_socket_service_base::cancel(
    io_uring_socket_service_base::base_implementation_type& impl,
    netio::error_code& ec)
{
  if (!is_open(impl))
...
netio::error_code io_uring_socket_service_base::do_open(
    io_uring_socket_service_base::base_implementation_type& impl,
...
netio::error_code io_uring_socket_service_base::do_assign(
...
#endif // NETIO_DETAIL_IMPL_IO_URING_SOCKET_SERVICE_BASE_IPP
