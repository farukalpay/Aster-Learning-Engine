#ifndef NETIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
#define NETIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
...
netio::error_code reactive_descriptor_service::assign(
    reactive_descriptor_service::implementation_type& impl,
...
netio::error_code reactive_descriptor_service::close(
    reactive_descriptor_service::implementation_type& impl,
    netio::error_code& ec)
{
  if (is_open(impl))
...
netio::error_code reactive_descriptor_service::cancel(
    reactive_descriptor_service::implementation_type& impl,
    netio::error_code& ec)
{
  if (!is_open(impl))
...
#endif // NETIO_DETAIL_IMPL_REACTIVE_DESCRIPTOR_SERVICE_IPP
