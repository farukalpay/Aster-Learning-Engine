#ifndef NETIO_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
#define NETIO_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
...
void socket_select_interrupter::open_descriptors()
{
  ...
  if (acceptor.get() == invalid_socket)
    netio::detail::throw_error(ec, "socket_select_interrupter");
...
#endif // NETIO_DETAIL_IMPL_SOCKET_SELECT_INTERRUPTER_IPP
