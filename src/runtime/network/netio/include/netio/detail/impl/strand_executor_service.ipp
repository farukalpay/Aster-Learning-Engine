#ifndef NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP
#define NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP
...
{
  netio::detail::mutex::scoped_lock lock(service_->mutex_);
...
#endif // NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_IPP
