#ifndef NETIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
#define NETIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
...
# endif // defined(EFD_CLOEXEC) && defined(EFD_NONBLOCK)
  ...
  if (read_descriptor_ == -1)
  {
    ...
    else
    {
      ...
      netio::detail::throw_error(ec, "eventfd_select_interrupter");
    }
  }
}
...
#endif // NETIO_DETAIL_IMPL_EVENTFD_SELECT_INTERRUPTER_IPP
