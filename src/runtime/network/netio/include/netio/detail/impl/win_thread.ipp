#ifndef NETIO_DETAIL_IMPL_WIN_THREAD_IPP
#define NETIO_DETAIL_IMPL_WIN_THREAD_IPP
    ...
    func_base* arg, unsigned int stack_size)
{
  ...
  if (!arg->entry_event_)
  {
    ...
    netio::detail::throw_error(ec, "thread.entry_event");
  }
  ...
  if (!arg->exit_event_)
  {
    ...
    netio::error_code ec(last_error,
        netio::error::get_system_category());
    netio::detail::throw_error(ec, "thread.exit_event");
  }
...
#endif // NETIO_DETAIL_IMPL_WIN_THREAD_IPP
