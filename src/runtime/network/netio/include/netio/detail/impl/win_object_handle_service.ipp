#ifndef NETIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
#define NETIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
    ...
    win_object_handle_service::implementation_type& impl)
{
  ...
  if (is_open(impl))
  {
    NETIO_HANDLER_OPERATION((scheduler_.context(), "object_handle",
...
netio::error_code win_object_handle_service::assign(
    win_object_handle_service::implementation_type& impl,
...
netio::error_code win_object_handle_service::close(
    win_object_handle_service::implementation_type& impl,
    netio::error_code& ec)
{
  if (is_open(impl))
...
netio::error_code win_object_handle_service::cancel(
    win_object_handle_service::implementation_type& impl,
    netio::error_code& ec)
{
  if (is_open(impl))
...
#endif // NETIO_DETAIL_IMPL_WIN_OBJECT_HANDLE_SERVICE_IPP
