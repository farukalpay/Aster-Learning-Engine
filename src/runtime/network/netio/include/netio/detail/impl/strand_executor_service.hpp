#ifndef NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
#define NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
    ...
    >*)
{
  return strand_executor_service::do_execute(impl, ex,
      ...
      netio::query(ex, execution::allocator));
}
    ...
    Executor& ex, Function&& function, const Allocator& a)
{
  ...
  if (netio::query(ex, execution::blocking) != execution::blocking.never
  ...
  NETIO_HANDLER_CREATION((impl->service_->context(), *p.p,
...
#endif // NETIO_DETAIL_IMPL_STRAND_EXECUTOR_SERVICE_HPP
