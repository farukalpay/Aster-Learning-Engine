#ifndef NETIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
#define NETIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
...
struct handler_tracking_timestamp
{
  ...
  handler_tracking_timestamp()
  {
    typedef chrono_time_traits<chrono::system_clock,
        netio::wait_traits<chrono::system_clock>> traits_helper;
...
{
  static tracking_state state = { NETIO_STATIC_MUTEX_INIT, 1, 0, 0 };
  return &state;
}
    ...
    uintmax_t /*native_handle*/, const char* op_name)
{
      ...
      current_location; current_location = current_location->next_)
  {
    write_line(
        ...
        "@netio|%I64u.%06I64u|%I64u^%I64u|%s%s%.80s%s(%.80s:%d)\n",
#else // defined(NETIO_WINDOWS)
        "@netio|%llu.%06llu|%llu^%llu|%s%s%.80s%s(%.80s:%d)\n",
#endif // defined(NETIO_WINDOWS)
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|%I64u*%I64u|%.20s@%p.%.50s\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|%llu*%llu|%.20s@%p.%.50s\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
...
handler_tracking::completion::~completion()
{
  if (id_)
  {
    ...
    write_line(
#if defined(NETIO_WINDOWS)
        "@netio|%I64u.%06I64u|%c%I64u|\n",
#else // defined(NETIO_WINDOWS)
        "@netio|%llu.%06llu|%c%llu|\n",
#endif // defined(NETIO_WINDOWS)
        timestamp.seconds, timestamp.microseconds,
        invoked_ ? '!' : '~', id_);
  }
    ...
    const netio::error_code& ec)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|>%I64u|ec=%.20s:%d\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|>%llu|ec=%.20s:%d\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
    ...
    const netio::error_code& ec, std::size_t bytes_transferred)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|>%I64u|ec=%.20s:%d,bytes_transferred=%I64u\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|>%llu|ec=%.20s:%d,bytes_transferred=%llu\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
      id_, ec.category().name(), ec.value(),
    ...
    const netio::error_code& ec, int signal_number)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|>%I64u|ec=%.20s:%d,signal_number=%d\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|>%llu|ec=%.20s:%d,signal_number=%d\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
    ...
    const netio::error_code& ec, const char* arg)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|>%I64u|ec=%.20s:%d,%.50s\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|>%llu|ec=%.20s:%d,%.50s\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
    ...
    uintmax_t /*native_handle*/, const char* op_name)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|%I64u|%.20s@%p.%.50s\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|%llu|%.20s@%p.%.50s\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
    ...
    const netio::error_code& ec)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|.%I64u|%s,ec=%.20s:%d\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|.%llu|%s,ec=%.20s:%d\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
    ...
    const netio::error_code& ec, std::size_t bytes_transferred)
{
  ...
  write_line(
#if defined(NETIO_WINDOWS)
      "@netio|%I64u.%06I64u|.%I64u|%s,ec=%.20s:%d,bytes_transferred=%I64u\n",
#else // defined(NETIO_WINDOWS)
      "@netio|%llu.%06llu|.%llu|%s,ec=%.20s:%d,bytes_transferred=%llu\n",
#endif // defined(NETIO_WINDOWS)
      timestamp.seconds, timestamp.microseconds,
      h.id_, op_name, ec.category().name(), ec.value(),
      static_cast<uint64_t>(bytes_transferred));
...
#endif // NETIO_DETAIL_IMPL_HANDLER_TRACKING_IPP
