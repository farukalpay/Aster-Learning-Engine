#ifndef NETIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
#define NETIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
...
{
public:
  reactive_socket_accept_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_accept", o->ec_));
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_accept_op);

  reactive_socket_accept_op(const netio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_move_accept_op);

  reactive_socket_move_accept_op(const netio::error_code& success_ec,
      ...
      std::size_t /*bytes_transferred*/)
  {
    ...
    detail::move_binder2<Handler,
      netio::error_code, peer_socket_type>
...
#endif // NETIO_DETAIL_REACTIVE_SOCKET_ACCEPT_OP_HPP
