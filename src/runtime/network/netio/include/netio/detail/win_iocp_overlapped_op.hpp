#ifndef NETIO_DETAIL_WIN_IOCP_OVERLAPPED_OP_HPP
#define NETIO_DETAIL_WIN_IOCP_OVERLAPPED_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(win_iocp_overlapped_op);
...
#endif // NETIO_DETAIL_WIN_IOCP_OVERLAPPED_OP_HPP
