#ifndef NETIO_DETAIL_IO_OBJECT_IMPL_HPP
#define NETIO_DETAIL_IO_OBJECT_IMPL_HPP
...
public:
  ...
  explicit io_object_impl(int, int, ExecutionContext& context)
    : service_(&netio::use_service<IoObjectService>(context)),
...
#endif // NETIO_DETAIL_IO_OBJECT_IMPL_HPP
