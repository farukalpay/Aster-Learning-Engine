#ifndef NETIO_DETAIL_IO_URING_FILE_SERVICE_HPP
#define NETIO_DETAIL_IO_URING_FILE_SERVICE_HPP
...
public:
  ...
  NETIO_DECL io_uring_file_service(execution_context& context);
...
#endif // NETIO_DETAIL_IO_URING_FILE_SERVICE_HPP
