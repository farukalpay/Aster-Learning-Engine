#ifndef NETIO_DETAIL_REACTOR_OP_QUEUE_HPP
#define NETIO_DETAIL_REACTOR_OP_QUEUE_HPP
...
public:
  ...
  bool cancel_operations_by_key(iterator i, op_queue<operation>& ops,
      void* cancellation_key, const netio::error_code& ec =
        netio::error::operation_aborted)
  {
    bool result = false;
    if (i != operations_.end())
...
#endif // NETIO_DETAIL_REACTOR_OP_QUEUE_HPP
