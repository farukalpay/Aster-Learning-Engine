#ifndef NETIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP
...
{
public:
  io_uring_socket_accept_op_base(const netio::error_code& success_ec,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_accept_op);

  io_uring_socket_accept_op(const netio::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_move_accept_op);

  io_uring_socket_move_accept_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_ACCEPT_OP_HPP
