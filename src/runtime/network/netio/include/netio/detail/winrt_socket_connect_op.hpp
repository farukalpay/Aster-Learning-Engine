#ifndef NETIO_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
#define NETIO_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(winrt_socket_connect_op);
...
#endif // NETIO_DETAIL_WINRT_SOCKET_CONNECT_OP_HPP
