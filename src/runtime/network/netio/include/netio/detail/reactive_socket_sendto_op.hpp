#ifndef NETIO_DETAIL_REACTIVE_SOCKET_SENDTO_OP_HPP
#define NETIO_DETAIL_REACTIVE_SOCKET_SENDTO_OP_HPP
...
{
public:
  reactive_socket_sendto_op_base(const netio::error_code& success_ec,
  ...
  static status do_perform(reactor_op* base)
  {
    ...
    NETIO_HANDLER_REACTOR_OPERATION((*o, "non_blocking_sendto",
...
public:
  ...
  NETIO_DEFINE_HANDLER_PTR(reactive_socket_sendto_op);

  reactive_socket_sendto_op(const netio::error_code& success_ec,
      socket_type socket, const ConstBufferSequence& buffers,
      const Endpoint& endpoint, socket_base::message_flags flags,
...
#endif // NETIO_DETAIL_REACTIVE_SOCKET_SENDTO_OP_HPP
