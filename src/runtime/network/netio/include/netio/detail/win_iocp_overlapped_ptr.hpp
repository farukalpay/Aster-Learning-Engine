#ifndef NETIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
#define NETIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
...
#include "netio/detail/win_iocp_overlapped_op.hpp"
...
public:
  ...
  void reset(const Executor& ex, Handler handler)
  {
    ...
    NETIO_HANDLER_CREATION((ex.context(), *p.p,
  ...
  void complete(const netio::error_code& ec,
...
private:
      ...
      >* = 0)
  {
    return &use_service<win_iocp_io_context>(
        netio::query(ex, execution::context));
  }
  ...
  {
    return &netio::query(ex, execution::context).impl_;
  }
...
#endif // NETIO_DETAIL_WIN_IOCP_OVERLAPPED_PTR_HPP
