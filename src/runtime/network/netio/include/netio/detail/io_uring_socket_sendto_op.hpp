#ifndef NETIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
#define NETIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
...
{
public:
  io_uring_socket_sendto_op_base(const netio::error_code& success_ec,
...
private:
  ...
  buffer_sequence_adapter<netio::const_buffer, ConstBufferSequence> bufs_;
  msghdr msghdr_;
};
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(io_uring_socket_sendto_op);

  io_uring_socket_sendto_op(const netio::error_code& success_ec,
...
#endif // NETIO_DETAIL_IO_URING_SOCKET_SENDTO_OP_HPP
