#ifndef NETIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP
#define NETIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP
...
{
public:
  NETIO_DEFINE_HANDLER_PTR(win_iocp_null_buffers_op);
...
#endif // NETIO_DETAIL_WIN_IOCP_NULL_BUFFERS_OP_HPP
