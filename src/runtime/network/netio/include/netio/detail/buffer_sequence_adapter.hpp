#ifndef NETIO_DETAIL_BUFFER_SEQUENCE_ADAPTER_HPP
#define NETIO_DETAIL_BUFFER_SEQUENCE_ADAPTER_HPP
...
protected:
  ...
  NETIO_DECL static void init_native_buffer(
...
public:
    ...
    : count_(0), total_buffer_size_(0)
  {
    buffer_sequence_adapter::init(
        netio::buffer_sequence_begin(buffer_sequence),
        netio::buffer_sequence_end(buffer_sequence));
  }
  ...
  static Buffer linearise(const Buffers& buffer_sequence,
      const netio::mutable_buffer& storage)
  {
    return buffer_sequence_adapter::linearise(
        netio::buffer_sequence_begin(buffer_sequence),
        netio::buffer_sequence_end(buffer_sequence), storage);
  }
...
private:
  ...
  static Buffer linearise(Iterator begin, Iterator end,
      const netio::mutable_buffer& storage)
  {
    netio::mutable_buffer unused_storage = storage;
    Iterator iter = begin;
    while (iter != end && unused_storage.size() != 0)
    {
      ...
      unused_storage += netio::buffer_copy(unused_storage, buffer);
    }
...
class buffer_sequence_adapter<Buffer, netio::mutable_buffer>
  : buffer_sequence_adapter_base
{
public:
  ...
  explicit buffer_sequence_adapter(
      const netio::mutable_buffer& buffer_sequence)
  {
  ...
  static bool all_empty(const netio::mutable_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const netio::mutable_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const netio::mutable_buffer& buffer_sequence)
  {
  ...
  static Buffer linearise(const netio::mutable_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, netio::const_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const netio::const_buffer& buffer_sequence)
  {
    init_native_buffer(buffer_, Buffer(buffer_sequence));
    total_buffer_size_ = buffer_sequence.size();
  }
  ...
  static bool all_empty(const netio::const_buffer& buffer_sequence)
  {
    return buffer_sequence.size() == 0;
  }

  static void validate(const netio::const_buffer& buffer_sequence)
  {
    buffer_sequence.data();
  }

  static Buffer first(const netio::const_buffer& buffer_sequence)
  {
    return Buffer(buffer_sequence);
  }
  ...
  static Buffer linearise(const netio::const_buffer& buffer_sequence,
      const Buffer&)
  {
    return Buffer(buffer_sequence);
  }
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, netio::mutable_registered_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const netio::mutable_registered_buffer& buffer_sequence)
  {
...
template <typename Buffer>
class buffer_sequence_adapter<Buffer, netio::const_registered_buffer>
  : buffer_sequence_adapter_base
{
public:
  enum { is_single_buffer = true };
  ...
  explicit buffer_sequence_adapter(
      const netio::const_registered_buffer& buffer_sequence)
  {
    init_native_buffer(buffer_, buffer_sequence.buffer());
    total_buffer_size_ = buffer_sequence.size();
    registered_id_ = buffer_sequence.id();
...
public:
      ...
      const netio::mutable_buffer& storage)
  {
    ...
    return Buffer(storage.data(),
        netio::buffer_copy(storage, buffer_sequence));
  }
...
#endif // NETIO_DETAIL_BUFFER_SEQUENCE_ADAPTER_HPP
