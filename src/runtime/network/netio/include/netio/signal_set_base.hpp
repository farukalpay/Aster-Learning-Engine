#ifndef NETIO_SIGNAL_SET_BASE_HPP
#define NETIO_SIGNAL_SET_BASE_HPP
...
# if defined(GENERATING_DOCUMENTATION)
  ...
  {
    none = 0,
    restart = NETIO_OS_DEF(SA_RESTART),
    no_child_stop = NETIO_OS_DEF(SA_NOCLDSTOP),
    no_child_wait = NETIO_OS_DEF(SA_NOCLDWAIT),
    dont_care = -1
  };
...
#endif // NETIO_SIGNAL_SET_BASE_HPP
