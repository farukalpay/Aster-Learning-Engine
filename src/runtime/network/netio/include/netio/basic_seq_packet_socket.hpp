#ifndef NETIO_BASIC_SEQ_PACKET_SOCKET_HPP
#define NETIO_BASIC_SEQ_PACKET_SOCKET_HPP
...
#if !defined(NETIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL)
#define NETIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Protocol, typename Executor = any_io_executor>
class basic_seq_packet_socket;

#endif // !defined(NETIO_BASIC_SEQ_PACKET_SOCKET_FWD_DECL)
...
public:
   ...
   * follows:
   * @code
   * socket.receive(netio::buffer(data, size), out_flags);
   * @endcode
   ...
   * follows:
   * @code
   * socket.receive(netio::buffer(data, size), 0, out_flags);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code
   * socket.async_receive(netio::buffer(data, size), out_flags, handler);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
...
#endif // NETIO_BASIC_SEQ_PACKET_SOCKET_HPP
