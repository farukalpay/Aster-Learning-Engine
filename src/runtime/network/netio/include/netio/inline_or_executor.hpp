#ifndef NETIO_INLINE_OR_EXECUTOR_HPP
#define NETIO_INLINE_OR_EXECUTOR_HPP
...
#include "netio/execution/inline_exception_handling.hpp"
...
public:
   ...
   *
   * For example:
   * @code netio::inline_or_executor<my_executor_type> ex = ...;
   * if (netio::query(ex, netio::execution::blocking)
   *     == netio::execution::blocking.possibly)
   *   ... @endcode
   */
   ...
   *     == netio::execution::inline_exception_handling.propagate)
   *   ... @endcode
   */
   ...
   * @code netio::inline_or_executor<my_executor_type> ex = ...;
   * if (netio::query(ex, netio::execution::blocking)
   *       == netio::execution::blocking.never)
   *   ... @endcode
   */
   ...
   * @code netio::inline_or_executor<my_executor_type> ex = ...;
   * auto ex2 = netio::require(ex1,
   *     netio::execution::inline_exception_handling.propagate); @endcode
   */
   ...
   * @code netio::inline_or_executor<my_executor_type> ex = ...;
   * auto ex2 = netio::require(ex1,
   *     netio::execution::inline_exception_handling.terminate); @endcode
   */
  inline_or_executor<Executor, Blocking,
   ...
   *
   * For example:
   * @code netio::inline_or_executor<my_executor_type> ex1 = ...;
   * auto ex2 = netio::require(ex1,
    ...
    noexcept(is_nothrow_require<const Executor&, Property>::value)
  {
    return inline_or_executor<
        ...
        Blocking, InlineExceptionHandling>(netio::require(executor_, p));
  }
    ...
    noexcept(is_nothrow_prefer<const Executor&, Property>::value)
  {
    return inline_or_executor<
        ...
        Blocking, InlineExceptionHandling>(netio::prefer(executor_, p));
  }
...
private:
  ...
  {
    netio::require(executor_, execution::blocking.never).execute(
...
/** @defgroup inline_or netio::inline_or
 *
 * @brief The netio::inline_or function creates an @ref inline_or_executor
...
#endif // NETIO_INLINE_OR_EXECUTOR_HPP
