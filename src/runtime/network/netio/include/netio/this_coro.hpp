#ifndef NETIO_THIS_CORO_HPP
#define NETIO_THIS_CORO_HPP
...
NETIO_INLINE_VARIABLE constexpr executor_t executor;
...
/**
 * @par Example
 * @code netio::awaitable<void> my_coroutine()
 * {
 *   netio::cancellation_state cs
 *     = co_await netio::this_coro::cancellation_state;
 *
 *   // ...
 *
 *   if (cs.cancelled() != netio::cancellation_type::none)
 *     // ...
 * } @endcode
 */
NETIO_INLINE_VARIABLE constexpr cancellation_state_t cancellation_state;
 ...
 * netio::cancellation_state object <tt>S</tt>, constructed as
 * <tt>S(P)</tt>, into the current coroutine's cancellation state object.
 *
 * @par Example
 * @code netio::awaitable<void> my_coroutine()
 * {
 *   co_await netio::this_coro::reset_cancellation_state();
 *
 *   // ...
 * } @endcode
 *
 * @note The cancellation state is shared by all coroutines in the same "thread
 * of execution" that was created using netio::co_spawn.
 */
NETIO_NODISCARD constexpr unspecified
 ...
 * Let <tt>P</tt> be the cancellation slot associated with the current
 * coroutine's @ref co_spawn completion handler. Assigns a new
 * netio::cancellation_state object <tt>S</tt>, constructed as <tt>S(P,
 ...
 * {
 *   co_await netio::this_coro::reset_cancellation_state(
 *       netio::enable_partial_cancellation());
 *
 *   // ...
 * } @endcode
 *
 ...
 * @code netio::awaitable<void> my_coroutine()
 * {
 *   if (co_await netio::this_coro::throw_if_cancelled)
 *     // ...
 *
 *   // ...
 * } @endcode
 ...
 * @code netio::awaitable<void> my_coroutine()
 * {
 *   co_await netio::this_coro::throw_if_cancelled(false);
 *
 *   // ...
 * } @endcode
 */
...
NETIO_NODISCARD inline constexpr reset_cancellation_state_0_t
reset_cancellation_state()
{
...
template <typename Filter>
NETIO_NODISCARD inline constexpr reset_cancellation_state_1_t<
    decay_t<Filter>>
reset_cancellation_state(Filter&& filter)
{
...
NETIO_NODISCARD inline constexpr throw_if_cancelled_0_t
throw_if_cancelled()
{
...
NETIO_NODISCARD inline constexpr throw_if_cancelled_1_t
throw_if_cancelled(bool value)
{
