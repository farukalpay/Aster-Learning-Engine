#ifndef NETIO_ASSOCIATED_EXECUTOR_HPP
#define NETIO_ASSOCIATED_EXECUTOR_HPP
...
{
  typedef void netio_associated_executor_is_unspecialised;
 ...
 */
template <typename T>
NETIO_NODISCARD inline typename associated_executor<T>::type
 ...
 */
template <typename T, typename Executor>
NETIO_NODISCARD inline auto get_associated_executor(
...
NETIO_NODISCARD inline typename associated_executor<T,
    ...
    enable_if_t<
      is_same<
        typename associated_executor<T,
          E>::netio_associated_executor_is_unspecialised,
        void
      >::value
    >>
{
...
#endif // NETIO_ASSOCIATED_EXECUTOR_HPP
