#ifndef NETIO_READ_HPP
#define NETIO_READ_HPP
 ...
 * @code netio::read(s, netio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code netio::read(s, netio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code netio::read(s, netio::buffer(data, size),
 *     netio::transfer_at_least(32)); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 */
...
/*@}*/
/**
 * @defgroup async_read netio::async_read
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * netio::async_read(s, netio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code netio::async_read(s,
 *     netio::buffer(data, size),
 *     netio::transfer_at_least(32),
 *     handler); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include "netio/impl/read.hpp"

#endif // NETIO_READ_HPP
