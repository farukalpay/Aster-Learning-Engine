#ifndef NETIO_USE_FUTURE_HPP
#define NETIO_USE_FUTURE_HPP
 ...
 * operation, typically using the special value @c netio::use_future. For
 * example:
 *
 * @code std::future<std::size_t> my_future
 *   = my_socket.async_read_some(my_buffer, netio::use_future); @endcode
 *
...
public:
   ...
   *     use_future([](netio::error_code ec, std::size_t n)
   *       {
   *         return ec ? 0 : n;
   *       }));
   * ...
...
/// return a future.
/**
 * See the documentation for netio::use_future_t for a usage example.
 */
NETIO_INLINE_VARIABLE constexpr use_future_t<> use_future;

} // namespace netio

#include "netio/detail/pop_options.hpp"

#include "netio/impl/use_future.hpp"

#endif // defined(NETIO_HAS_STD_FUTURE_CLASS)
       //   || defined(GENERATING_DOCUMENTATION)

#endif // NETIO_USE_FUTURE_HPP
