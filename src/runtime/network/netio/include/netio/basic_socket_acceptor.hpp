#ifndef NETIO_BASIC_SOCKET_ACCEPTOR_HPP
#define NETIO_BASIC_SOCKET_ACCEPTOR_HPP
 ...
 * @code
 * netio::ip::tcp::acceptor acceptor(my_context);
 * netio::ip::tcp::endpoint endpoint(netio::ip::tcp::v4(), port);
 * acceptor.open(endpoint.protocol());
 * acceptor.set_option(netio::ip::tcp::acceptor::reuse_address(true));
...
public:
    ...
    : impl_(0, ex)
  {
    ...
    netio::detail::throw_error(ec, "listen");
  }
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * netio::error_code ec;
   * acceptor.open(netio::ip::tcp::v4(), ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  NETIO_SYNC_OP_VOID assign(const protocol_type& protocol,
      const native_handle_type& native_acceptor, netio::error_code& ec)
  {
    impl_.get_service().assign(impl_.get_implementation(),
        protocol, native_acceptor, ec);
    NETIO_SYNC_OP_VOID_RETURN(ec);
   ...
   * @code
   * netio::ip::tcp::acceptor acceptor(my_context);
   * netio::ip::tcp::endpoint endpoint(netio::ip::tcp::v4(), 12345);
   * acceptor.open(endpoint.protocol());
   * acceptor.bind(endpoint);
   * @endcode
   */
   ...
   * ...
   * netio::error_code ec;
   * acceptor.listen(netio::socket_base::max_listen_connections, ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   * @endcode
   */
  NETIO_SYNC_OP_VOID listen(int backlog, netio::error_code& ec)
  {
    impl_.get_service().listen(impl_.get_implementation(), backlog, ec);
    NETIO_SYNC_OP_VOID_RETURN(ec);
  }
   ...
   * passed the netio::error::operation_aborted error. Ownership of the
   ...
   * netio::socket_base::reuse_address
   * netio::socket_base::enable_connection_aborted
   *
   * @par Example
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::acceptor::reuse_address option(true);
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::acceptor::reuse_address option;
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::acceptor::non_blocking_io command(true);
   ...
   * with netio::error::would_block if they are unable to perform the
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::endpoint endpoint = acceptor.local_endpoint();
   * @endcode
   */
   ...
   * ...
   * netio::error_code ec;
   * netio::ip::tcp::endpoint endpoint = acceptor.local_endpoint(ec);
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * acceptor.wait(netio::ip::tcp::acceptor::wait_read);
   * @endcode
   */
   ...
   * ...
   * netio::error_code ec;
   * acceptor.wait(netio::ip::tcp::acceptor::wait_read, ec);
   * @endcode
   */
   ...
   * ...
   * acceptor.async_wait(
   *     netio::ip::tcp::acceptor::wait_read,
   *     wait_handler);
   * @endcode
   *
      ...
      > = 0)
  {
    ...
    netio::detail::throw_error(ec, "accept");
  }
   ...
   */
  template <typename Protocol1, typename Executor1>
  NETIO_SYNC_OP_VOID accept(
      basic_socket<Protocol1, Executor1>& peer, netio::error_code& ec,
      constraint_t<
        is_convertible<Protocol, Protocol1>::value
      > = 0)
  {
   ...
   * @par Example
   * @code
   * void accept_handler(const netio::error_code& error)
   * {
   *   if (!error)
   *   {
   *     // Accept succeeded.
  ...
  auto async_accept(basic_socket<Protocol1, Executor1>& peer,
      ...
      > = 0)
    -> decltype(
      async_initiate<AcceptToken, void (netio::error_code)>(
        declval<initiate_async_accept>(), token,
        &peer, static_cast<endpoint_type*>(0)))
  {
    return async_initiate<AcceptToken, void (netio::error_code)>(
   ...
   */
  template <typename Executor1>
  NETIO_SYNC_OP_VOID accept(basic_socket<protocol_type, Executor1>& peer,
      endpoint_type& peer_endpoint, netio::error_code& ec)
  {
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::socket socket(acceptor.accept());
   * @endcode
   */
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::socket socket(acceptor.accept(ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  auto async_accept(
    ...
    -> decltype(
      async_initiate<MoveAcceptToken,
        void (netio::error_code, typename Protocol::socket::template
   ...
   * netio::ip::tcp::acceptor acceptor(my_context);
   * ...
   * netio::ip::tcp::socket socket(acceptor.accept(my_context2, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
  ...
  template <typename Executor1>
  typename Protocol::socket::template rebind_executor<Executor1>::other
  accept(const Executor1& ex, netio::error_code& ec,
      constraint_t<
        is_executor<Executor1>::value
          || execution::is_executor<Executor1>::value
      > = 0)
  ...
  typename Protocol::socket::template rebind_executor<
      typename ExecutionContext::executor_type>::other
  accept(ExecutionContext& context, netio::error_code& ec,
      constraint_t<
        is_convertible<ExecutionContext&, execution_context&>::value
      > = 0)
  {
   ...
   * ...
   * netio::ip::tcp::endpoint endpoint;
   * netio::ip::tcp::socket socket(acceptor.accept(endpoint));
   * @endcode
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
   ...
   * ...
   * netio::ip::tcp::endpoint endpoint;
   * netio::ip::tcp::socket socket(acceptor.accept(endpoint, ec));
   * if (ec)
   * {
   *   // An error occurred.
   * }
   ...
   */
  typename Protocol::socket::template rebind_executor<executor_type>::other
  accept(endpoint_type& peer_endpoint, netio::error_code& ec)
  {
    typename Protocol::socket::template rebind_executor<
      executor_type>::other peer(impl_.get_executor());
    impl_.get_service().accept(impl_.get_implementation(),
...
private:
  ...
  public:
        ...
        endpoint_type* peer_endpoint) const
    {
      ...
      NETIO_ACCEPT_HANDLER_CHECK(AcceptHandler, handler) type_check;
  ...
  public:
        ...
        const Executor1& peer_ex, endpoint_type* peer_endpoint, Socket*) const
    {
      ...
      NETIO_MOVE_ACCEPT_HANDLER_CHECK(
...
#endif // NETIO_BASIC_SOCKET_ACCEPTOR_HPP
