#ifndef NETIO_READ_AT_HPP
#define NETIO_READ_AT_HPP
...
/**
 * @defgroup read_at netio::read_at
 *
 ...
 * @code netio::read_at(d, 42, netio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code netio::read_at(d, 42,
 *     netio::buffer(data, size), ec); @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 *
 ...
 * @par Example
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code netio::read_at(d, 42, netio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_read_at netio::async_read_at
 *
 ...
 * To read into a single data buffer use the @ref buffer function as follows:
 * @code
 * netio::async_read_at(d, 42, netio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on reading into multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
...
#include "netio/impl/read_at.hpp"

#endif // NETIO_READ_AT_HPP
