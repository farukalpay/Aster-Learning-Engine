#ifndef NETIO_BASIC_READABLE_PIPE_HPP
#define NETIO_BASIC_READABLE_PIPE_HPP
...
public:
   ...
   * @code
   * basic_readable_pipe.read_some(netio::buffer(data, size));
   * @endcode
...
#endif // NETIO_BASIC_READABLE_PIPE_HPP
