#ifndef NETIO_CANCELLATION_STATE_HPP
#define NETIO_CANCELLATION_STATE_HPP
...
public:
   ...
   * @code netio::cancellation_type_t filter(
   *     netio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
   * @li netio::disable_cancellation
   * @li netio::enable_terminal_cancellation
   * @li netio::enable_partial_cancellation
   * @li netio::enable_total_cancellation
   */
   ...
   * cancellation signals as they are received from the parent slot. This
   * function object must have the signature:
   * @code netio::cancellation_type_t in_filter(
   *     netio::cancellation_type_t); @endcode
   *
   ...
   * @code netio::cancellation_type_t out_filter(
   *     netio::cancellation_type_t); @endcode
   *
   * The library provides the following pre-defined cancellation filters:
   *
...
#endif // NETIO_CANCELLATION_STATE_HPP
