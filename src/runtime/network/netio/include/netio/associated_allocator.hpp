#ifndef NETIO_ASSOCIATED_ALLOCATOR_HPP
#define NETIO_ASSOCIATED_ALLOCATOR_HPP
...
{
  typedef void netio_associated_allocator_is_unspecialised;
 ...
 */
template <typename T>
NETIO_NODISCARD inline typename associated_allocator<T>::type
 ...
 */
template <typename T, typename Allocator>
NETIO_NODISCARD inline auto get_associated_allocator(
    ...
    enable_if_t<
      is_same<
        typename associated_allocator<T,
          A>::netio_associated_allocator_is_unspecialised,
        void
      >::value
    >>
{
...
#endif // NETIO_ASSOCIATED_ALLOCATOR_HPP
