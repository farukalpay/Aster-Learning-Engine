#ifndef NETIO_BUFFER_HPP
#define NETIO_BUFFER_HPP
...
#include <string>
#include <vector>
#include "netio/detail/array_fwd.hpp"
...
#if defined(NETIO_MSVC) && (NETIO_MSVC >= 1700)
# if defined(_HAS_ITERATOR_DEBUGGING) && (_HAS_ITERATOR_DEBUGGING != 0)
#  if !defined(NETIO_DISABLE_BUFFER_DEBUGGING)
#   define NETIO_ENABLE_BUFFER_DEBUGGING
#  endif // !defined(NETIO_DISABLE_BUFFER_DEBUGGING)
# endif // defined(_HAS_ITERATOR_DEBUGGING)
#endif // defined(NETIO_MSVC) && (NETIO_MSVC >= 1700)
...
#endif // NETIO_ENABLE_BUFFER_DEBUGGING
...
public:
  ...
  mutable_buffer(void* data, std::size_t size,
      netio::detail::function<void()> debug_check)
    : data_(data),
      size_(size),
  ...
  const netio::detail::function<void()>& get_debug_check() const
  {
    return debug_check_;
  }
#endif // NETIO_ENABLE_BUFFER_DEBUGGING
...
#if defined(NETIO_ENABLE_BUFFER_DEBUGGING)
  netio::detail::function<void()> debug_check_;
#endif // NETIO_ENABLE_BUFFER_DEBUGGING
};
...
/** @defgroup buffer_sequence_begin netio::buffer_sequence_begin
 *
 * @brief The netio::buffer_sequence_begin function returns an iterator
...
/** @defgroup buffer_sequence_end netio::buffer_sequence_end
 *
 * @brief The netio::buffer_sequence_end function returns an iterator
 ...
 * auto i = netio::buffer_sequence_begin(buffers);
 * auto end = netio::buffer_sequence_end(buffers);
 * for (; i != end; ++i)
 * {
 *   const_buffer b(*i);
 *   total_size += b.size();
...
inline std::size_t buffer_size(const BufferSequence& b) noexcept
{
  return detail::buffer_size(
      ...
      netio::buffer_sequence_begin(b),
      netio::buffer_sequence_end(b));
}
...
public:
  ...
  ~buffer_debug_check()
  {
    ...
    iter_ = Iterator();
#endif // defined(NETIO_MSVC) && (NETIO_MSVC == 1400)
  }
...
/** @defgroup buffer netio::buffer
 *
 * @brief The netio::buffer function is used to create a buffer object to
 ...
 * specified size:
 *
 * @code sock.send(netio::buffer(data, size)); @endcode
 *
 * In the above example, the return value of netio::buffer meets the
 ...
 *
 * @code char d1[128];
 * size_t bytes_transferred = sock.receive(netio::buffer(d1));
 *
 * std::vector<char> d2(128);
 * bytes_transferred = sock.receive(netio::buffer(d2));
 *
 * std::array<char, 128> d3;
 * bytes_transferred = sock.receive(netio::buffer(d3));
 *
 * boost::array<char, 128> d4;
 * bytes_transferred = sock.receive(netio::buffer(d4)); @endcode
 *
 ...
 *
 * vector<unsigned char> data(netio::buffer_size(buffers));
 * netio::buffer_copy(netio::buffer(data), buffers); @endcode
 *
 ...
 *
 * For the netio::buffer overloads that accept an argument of type
 ...
 *
 * @code b1 = netio::buffer(a); @endcode
 *
 * represents the entire array, <tt>{ 'a', 'b', 'c', 'd', 'e' }</tt>. An
 * optional second argument to the netio::buffer function may be used to
 * limit the size, in bytes, of the buffer:
 *
 * @code b2 = netio::buffer(a, 3); @endcode
 *
 ...
 *
 * @code b4 = netio::buffer(b1 + 1, 3); @endcode
 *
 ...
 * bufs2.push_back(netio::buffer(d1));
 * bufs2.push_back(netio::buffer(d2));
 * bufs2.push_back(netio::buffer(d3));
 * bytes_transferred = sock.send(bufs2); @endcode
 *
 * @par Buffer Literals
 *
 * The `_buf` literal suffix, defined in namespace
 * <tt>netio::buffer_literals</tt>, may be used to create @c const_buffer
 * objects from string, binary integer, and hexadecimal integer literals.
 * For example:
 *
 * @code
 * using namespace netio::buffer_literals;
 *
 * netio::const_buffer b1 = "hello"_buf;
 * netio::const_buffer b2 = 0xdeadbeef_buf;
 * netio::const_buffer b3 = 0x0123456789abcdef0123456789abcdef_buf;
 * netio::const_buffer b4 = 0b1010101011001100_buf; @endcode
 *
 ...
 */
NETIO_NODISCARD inline mutable_buffer buffer(
    const mutable_buffer& b) noexcept
{
 ...
 */
NETIO_NODISCARD inline const_buffer buffer(
    const const_buffer& b) noexcept
{
...
public:
  ...
  explicit dynamic_string_buffer(std::basic_string<Elem, Traits, Allocator>& s,
    ...
    : string_(s),
#if !defined(NETIO_NO_DYNAMIC_BUFFER_V1)
      size_((std::numeric_limits<std::size_t>::max)()),
#endif // !defined(NETIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return const_buffers_type(netio::buffer(string_, size_));
  }
#endif // !defined(NETIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(netio::buffer(
          netio::buffer(string_, max_size_) + pos, n));
  }
  ...
  {
    return const_buffers_type(netio::buffer(
          netio::buffer(string_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return netio::buffer(netio::buffer(string_) + size_, n);
  }
...
public:
  ...
  const_buffers_type data() const noexcept
  {
    return const_buffers_type(netio::buffer(vector_, size_));
  }
#endif // !defined(NETIO_NO_DYNAMIC_BUFFER_V1)
  ...
  {
    return mutable_buffers_type(netio::buffer(
          netio::buffer(vector_, max_size_) + pos, n));
  }
  ...
  mutable_buffers_type prepare(std::size_t n)
  {
    ...
    return netio::buffer(netio::buffer(vector_) + size_, n);
  }
...
/** @defgroup dynamic_buffer netio::dynamic_buffer
 *
 * @brief The netio::dynamic_buffer function is used to create a
...
/** @defgroup buffer_copy netio::buffer_copy
 *
 * @brief The netio::buffer_copy function is used to copy bytes from a
    ...
    std::size_t max_bytes_to_copy) noexcept
{
  return (buffer_copy_1)(*target_begin,
      netio::buffer(*source_begin, max_bytes_to_copy));
}
      ...
      = (std::numeric_limits<std::size_t>::max)()) noexcept
{
  ...
  for (mutable_buffer target_buffer(
        netio::buffer(*target_begin, max_bytes_to_copy));
    ...
    std::size_t max_bytes_to_copy) noexcept
{
      ...
      && target_iter != target_end && source_iter != source_end)
  {
    ...
    std::size_t bytes_copied = (buffer_copy_1)(
        target_buffer, netio::buffer(source_buffer,
    ...
    const ConstBufferSequence& source) noexcept
{
  return detail::buffer_copy(
      ...
      netio::buffer_sequence_begin(target),
      netio::buffer_sequence_end(target),
      netio::buffer_sequence_begin(source),
      netio::buffer_sequence_end(source));
}
    ...
    std::size_t max_bytes_to_copy) noexcept
{
  return detail::buffer_copy(
      ...
      netio::buffer_sequence_end(target),
      netio::buffer_sequence_begin(source),
      netio::buffer_sequence_end(source), max_bytes_to_copy);
}
...
#include "netio/detail/is_buffer_sequence.hpp"
#include "netio/detail/push_options.hpp"
...
struct is_mutable_buffer_sequence
  ...
  : netio::detail::is_buffer_sequence<T, mutable_buffer>
...
struct is_const_buffer_sequence
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : netio::detail::is_buffer_sequence<T, const_buffer>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
struct is_dynamic_buffer_v1
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : netio::detail::is_dynamic_buffer_v1<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
#endif // !defined(NETIO_NO_DYNAMIC_BUFFER_V1)
...
struct is_dynamic_buffer_v2
  ...
  : integral_constant<bool, automatically_determined>
#else // defined(GENERATING_DOCUMENTATION)
  : netio::detail::is_dynamic_buffer_v2<T>
#endif // defined(GENERATING_DOCUMENTATION)
{
};
...
/**
 * If @c NETIO_NO_DYNAMIC_BUFFER_V1 is not defined, determines whether the
 * type satisfies the DynamicBuffer_v1 requirements. Otherwise, if @c
 * NETIO_NO_DYNAMIC_BUFFER_V1 is defined, determines whether the type
...
#if defined(GENERATING_DOCUMENTATION)
  : integral_constant<bool, automatically_determined>
#elif defined(NETIO_NO_DYNAMIC_BUFFER_V1)
  : netio::is_dynamic_buffer_v2<T>
#else // defined(NETIO_NO_DYNAMIC_BUFFER_V1)
  : netio::is_dynamic_buffer_v1<T>
#endif // defined(NETIO_NO_DYNAMIC_BUFFER_V1)
{
};
