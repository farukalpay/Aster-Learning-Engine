#ifndef NETIO_USE_AWAITABLE_HPP
#define NETIO_USE_AWAITABLE_HPP
...
/// coroutine.
/**
 * See the documentation for netio::use_awaitable_t for a usage example.
 */
#if defined(GENERATING_DOCUMENTATION)
NETIO_INLINE_VARIABLE constexpr use_awaitable_t<> use_awaitable;
#else
NETIO_INLINE_VARIABLE constexpr use_awaitable_t<> use_awaitable(0, 0, 0);
#endif
...
#include "netio/impl/use_awaitable.hpp"

#endif // defined(NETIO_HAS_CO_AWAIT) || defined(GENERATING_DOCUMENTATION)

#endif // NETIO_USE_AWAITABLE_HPP
