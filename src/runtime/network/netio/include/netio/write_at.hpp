#ifndef NETIO_WRITE_AT_HPP
#define NETIO_WRITE_AT_HPP
...
/**
 * @defgroup write_at netio::write_at
 *
 ...
 * @code netio::write_at(d, 42, netio::buffer(data, size)); @endcode
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code netio::write_at(d, 42, netio::buffer(data, size),
...
/*@}*/
/**
 * @defgroup async_write_at netio::async_write_at
 *
 ...
 * To write a single data buffer use the @ref buffer function as follows:
 * @code
 * netio::async_write_at(d, 42, netio::buffer(data, size), handler);
 * @endcode
 * See the @ref buffer documentation for information on writing multiple
 * buffers in one go, and how to use it with arrays, boost::array or
 * std::vector.
 ...
 * @par Example
 * To write a single data buffer use the @ref buffer function as follows:
 * @code netio::async_write_at(d, 42,
...
#include "netio/impl/write_at.hpp"

#endif // NETIO_WRITE_AT_HPP
