#ifndef NETIO_BASIC_RAW_SOCKET_HPP
#define NETIO_BASIC_RAW_SOCKET_HPP
...
#if !defined(NETIO_BASIC_RAW_SOCKET_FWD_DECL)
#define NETIO_BASIC_RAW_SOCKET_FWD_DECL

// Forward declaration with defaulted arguments.
template <typename Protocol, typename Executor = any_io_executor>
class basic_raw_socket;

#endif // !defined(NETIO_BASIC_RAW_SOCKET_FWD_DECL)
...
public:
   ...
   * @code socket.send(netio::buffer(data, size)); @endcode
   ...
   * To send a single data buffer use the @ref buffer function as follows:
   * @code
   * netio::ip::udp::endpoint destination(
   *     netio::ip::address::from_string("1.2.3.4"), 12345);
   * socket.send_to(netio::buffer(data, size), destination);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      const endpoint_type& destination)
  {
    ...
    netio::detail::throw_error(ec, "send_to");
    return s;
  }
   ...
   *     netio::buffer(data, size), destination, handler);
   * @endcode
   * See the @ref buffer documentation for information on sending multiple
   * buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   ...
   * follows:
   * @code socket.receive(netio::buffer(data, size)); @endcode
   ...
   * follows:
   * @code
   * netio::ip::udp::endpoint sender_endpoint;
   * socket.receive_from(
   *     netio::buffer(data, size), sender_endpoint);
   * @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
      ...
      endpoint_type& sender_endpoint)
  {
    ...
    netio::detail::throw_error(ec, "receive_from");
    return s;
  }
   ...
   *     netio::buffer(data, size), 0, sender_endpoint, handler); @endcode
   * See the @ref buffer documentation for information on receiving into
   * multiple buffers in one go, and how to use it with arrays, boost::array or
   * std::vector.
   *
...
#endif // NETIO_BASIC_RAW_SOCKET_HPP
