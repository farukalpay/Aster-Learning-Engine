#ifndef NETIO_ASSOCIATED_CANCELLATION_SLOT_HPP
#define NETIO_ASSOCIATED_CANCELLATION_SLOT_HPP
...
{
  typedef void netio_associated_cancellation_slot_is_unspecialised;
 ...
 */
template <typename T>
NETIO_NODISCARD inline typename associated_cancellation_slot<T>::type
 ...
 */
template <typename T, typename CancellationSlot>
NETIO_NODISCARD inline auto get_associated_cancellation_slot(
    ...
    enable_if_t<
      is_same<
        typename associated_cancellation_slot<T,
          S>::netio_associated_cancellation_slot_is_unspecialised,
        void
      >::value
    >>
{
...
#endif // NETIO_ASSOCIATED_CANCELLATION_SLOT_HPP
