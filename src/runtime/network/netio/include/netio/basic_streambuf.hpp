#ifndef NETIO_BASIC_STREAMBUF_HPP
#define NETIO_BASIC_STREAMBUF_HPP
 ...
 * implementation approach currently used in Netio.
 *
 ...
 * netio::streambuf::mutable_buffers_type bufs = b.prepare(512);
 *
...
public:
  ...
  {
    return netio::buffer(netio::const_buffer(gptr(),
  ...
  {
    reserve(n);
    return netio::buffer(netio::mutable_buffer(
...
protected:
  ...
  void reserve(std::size_t n)
  {
    ...
    if (n > pend - pnext)
    {
      ...
      {
        std::length_error ex("netio::streambuf too long");
...
#endif // NETIO_BASIC_STREAMBUF_HPP
