...
struct AsterAssetFoundryRecipe {
  ...
  AsterAssetFoundryProductionSession production_session;
};
...
struct AsterAssetFoundryDagReport {
...
struct AsterAssetFoundryRecipeAudit {
  ...
  AsterAssetFoundryDagReport dag;
  AsterAssetFoundryProductionSession production_session;
...
[[nodiscard]] AsterAssetFoundryDagReport
evaluateAsterAssetFoundryStageDag(const AsterAssetFoundryRecipe &recipe);
[[nodiscard]] AsterAssetFoundryProductionSession
makeAsterAssetFoundryProductionSession(const AsterAssetFoundryRecipe &recipe,
                                       std::string stable_recipe_hash = {});
